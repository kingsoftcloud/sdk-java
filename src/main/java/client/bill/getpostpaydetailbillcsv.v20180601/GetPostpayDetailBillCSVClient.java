...
public class GetPostpayDetailBillCSVClient extends BaseClient {
     ...
     * @throws Exception
     */
    public GetPostpayDetailBillCSVResponse doPost(String path, GetPostpayDetailBillCSVRequest requestObj, Map<String, String> head) throws Exception {
     ...
     * @throws Exception
     */
    public GetPostpayDetailBillCSVResponse doDelete(String path, GetPostpayDetailBillCSVRequest requestObj, Map<String, String> head) throws Exception {
        JSONObject requestParams = getRequestParams(requestObj);
     ...
     * @throws Exception
     */
    public GetPostpayDetailBillCSVResponse doPut(String path, GetPostpayDetailBillCSVRequest requestObj, Map<String, String> head) throws Exception {
        JSONObject requestParams = getRequestParams(requestObj);
     ...
     * @throws Exception
     */
    public GetPostpayDetailBillCSVResponse doGet(String path, GetPostpayDetailBillCSVRequest requestObj, Map<String, String> head) throws Exception {
        JSONObject requestParams = getRequestParams(requestObj);
