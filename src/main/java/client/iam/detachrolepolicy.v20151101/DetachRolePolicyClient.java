package client.iam.detachrolepolicy.v20151101;
...
public class DetachRolePolicyClient extends BaseClient {
    ...
    public DetachRolePolicyResponse doDelete(String path, DetachRolePolicyRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DetachRolePolicyResponse DetachRolePolicyResponse = JSON.parseObject(response, DetachRolePolicyResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(DetachRolePolicyRequest requestObj) throws Exception {
