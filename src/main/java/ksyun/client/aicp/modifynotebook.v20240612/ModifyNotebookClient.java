...
public class ModifyNotebookClient extends BaseClient {
    ...
    public ModifyNotebookResponse doDelete(String path, ModifyNotebookRequest requestObj, Map<String, String> head) throws Exception {
        ...
        ModifyNotebookResponse ModifyNotebookResponse = JSON.parseObject(response, ModifyNotebookResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(ModifyNotebookRequest requestObj) throws Exception {
