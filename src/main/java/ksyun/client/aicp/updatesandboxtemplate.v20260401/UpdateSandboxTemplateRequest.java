...
/**
* @Classname UpdateSandboxTemplateRequest
* @Description 请求参数
*/
@Data
public class UpdateSandboxTemplateRequest{
    /**模板ID*/
    ...
    /**模板描述。最长200位，允许字母、中文、数字、顿号、-、_、\、/、(、)、.、空格*/
...
*/
    ...
    /**镜像配置，TemplateCategory为Private时有效
...
*/
    ...
    public static class ImageConfigDto {
        /**镜像源，ImageConfig非null时必填。可选值：Personal,Enterprise,Public
...
*/
    ...
    /**网络访问配置，TemplateCategory为Private时生效
