...
/**
* @Classname DescribeInferencesResponse
* @Description DescribeInferences 返回体
*/
@Data
@ToString
public class DescribeInferencesResponse extends BaseResponseModel {
    ...
    /**推理服务详情*/
    @JsonProperty("InferenceSet")
    private List<InferenceSetDto> InferenceSet;

    @Data
    @ToString
    public static class InferenceSetDto {
        /**推理服务名称*/
        ...
        /**环境变量列表*/
        @JsonProperty("Env")
        private List<InferenceSetEnvDto> Env;

        @Data
        @ToString
        public static class InferenceSetEnvDto {
            /**环境变量名*/
            @JsonProperty("Name")
            private String Name;
        ...
        private List<InferenceSetStorageConfigsDto> StorageConfigs;

        @Data
        @ToString
        public static class InferenceSetStorageConfigsDto {
            /**存储配置ID*/
