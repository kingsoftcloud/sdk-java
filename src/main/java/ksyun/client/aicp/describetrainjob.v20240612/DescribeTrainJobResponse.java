...
public class DescribeTrainJobResponse extends BaseResponseModel {
    ...
    public static class TrainJobSetDto {
        ...
        private TrainJobSetFrameworkReplicasDto FrameworkReplicas;

        @Data
        @ToString
        public static class TrainJobSetFrameworkReplicasDto {
            /**1*/
            @JsonProperty("Master")
        ...
        /***/
        @JsonProperty("Status")
        private TrainJobSetStatusDto Status;

        @Data
        @ToString
        public static class TrainJobSetStatusDto {
            /**pending*/
            @JsonProperty("State")
        ...
        /**环境变量*/
        @JsonProperty("Envs")
        private List<TrainJobSetEnvsDto> Envs;

        @Data
        @ToString
        public static class TrainJobSetEnvsDto {
            /**ENV_TENSORBOARD_DIR*/
            @JsonProperty("Name")
            private String Name;
