...
/**
* @Classname DescribeInferenceAndPodEventsResponse
* @Description DescribeInferenceAndPodEvents 返回体
*/
@Data
@ToString
public class DescribeInferenceAndPodEventsResponse extends BaseResponseModel {
