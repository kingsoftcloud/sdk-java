...
/**
 * @Classname CreateJobRequest @Description 请求参数
 */
@Data
public class CreateJobRequest {
  ...
  /** 任务夯住自愈时间间隔 分钟为单位，不传默认为0，则不处理夯住场景 */
  ...
  public static class Space_storagesDto {
    /** 存储ID 注：可根据ListSpaceStorages接口查询可用的空间存储列表，查看该接口返回结果中的id字段 */
