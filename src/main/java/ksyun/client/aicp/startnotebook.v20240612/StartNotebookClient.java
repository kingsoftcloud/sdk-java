...
public class StartNotebookClient extends BaseClient {
    ...
    public StartNotebookResponse doDelete(String path, StartNotebookRequest requestObj, Map<String, String> head) throws Exception {
        ...
        StartNotebookResponse StartNotebookResponse = JSON.parseObject(response, StartNotebookResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(StartNotebookRequest requestObj) throws Exception {
