...
/**
* @Classname GetMcpOfficialServerDetailResponse
* @Description GetMcpOfficialServerDetail 返回体
*/
@Data
@ToString
public class GetMcpOfficialServerDetailResponse extends BaseResponseModel {
