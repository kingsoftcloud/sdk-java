...
/**
* @Classname DescribeMcpOfficialServersResponse
* @Description DescribeMcpOfficialServers 返回体
*/
@Data
@ToString
public class DescribeMcpOfficialServersResponse extends BaseResponseModel {
