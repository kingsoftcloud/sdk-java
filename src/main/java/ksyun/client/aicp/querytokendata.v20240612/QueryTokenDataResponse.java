...
public class QueryTokenDataResponse extends BaseResponseModel {
    ...
    public static class DataDto {
        ...
        /**生成视频时长（s）*/
        @JsonProperty("TotalVideoDuration")
    ...
    /**总共生成图片数量（张）*/
    @JsonProperty("SumTotalImageCount")
    private Long SumTotalImageCount;

    /**总共生成视频时长（s）*/
    @JsonProperty("SumTotalVideoDuration")
    private Long SumTotalVideoDuration;
