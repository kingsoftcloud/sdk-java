...
public class ListHistoryPubStreamsInfoClient extends BaseClient {
     ...
     * @return ListHistoryPubStreamsInfoResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doPostSend(String path, ListHistoryPubStreamsInfoRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doPostSend(String path, ListHistoryPubStreamsInfoRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doPostSend(String path, ListHistoryPubStreamsInfoRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doPostSend(String path, ListHistoryPubStreamsInfoRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doGetSend(String path, ListHistoryPubStreamsInfoRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doGetSend(String path, ListHistoryPubStreamsInfoRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doGetSend(String path, ListHistoryPubStreamsInfoRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doPutSend(String path, ListHistoryPubStreamsInfoRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doPutSend(String path, ListHistoryPubStreamsInfoRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doPutSend(String path, ListHistoryPubStreamsInfoRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doDeleteSend(String path, ListHistoryPubStreamsInfoRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doDeleteSend(String path, ListHistoryPubStreamsInfoRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ListHistoryPubStreamsInfoResponse doDeleteSend(String path, ListHistoryPubStreamsInfoRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private ListHistoryPubStreamsInfoResponse executeWithV2(String method, String path, ListHistoryPubStreamsInfoRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, ListHistoryPubStreamsInfoResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, ListHistoryPubStreamsInfoRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, ListHistoryPubStreamsInfoRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, ListHistoryPubStreamsInfoRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, ListHistoryPubStreamsInfoRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, ListHistoryPubStreamsInfoRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, ListHistoryPubStreamsInfoRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, ListHistoryPubStreamsInfoRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, ListHistoryPubStreamsInfoRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
    ...
    * @throws Exception
    */
    public ListHistoryPubStreamsInfoResponse doPostRaw(String path, ListHistoryPubStreamsInfoRequest requestObj, Map<String, String> head) throws Exception {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
        String response = doRpc(path, requestObj, requestHeaders, "post");
        return JSON.parseObject(response, ListHistoryPubStreamsInfoResponse.class);
    ...
    /**
         ...
         * @throws Exception
         */
        private String doRpc(String path, ListHistoryPubStreamsInfoRequest requestObj, Map<String, String> head, String requestMethod) throws Exception {
            //断言
        ...
        private JSONObject getRequestParam(ListHistoryPubStreamsInfoRequest requestObj, String contentType) throws Exception {
            //请求参数
        ...
        private JSONObject getPostRawRequestParams(ListHistoryPubStreamsInfoRequest requestObj) throws Exception {
            JSONObject requestParams = new JSONObject();
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, ListHistoryPubStreamsInfoRequest requestObj, Map<String, String> head,
