...
public class ResumeStreamClient extends BaseClient {
    ...
    public ResumeStreamResponse doDelete(String path, ResumeStreamRequest requestObj, Map<String, String> head) throws Exception {
        ...
        ResumeStreamResponse ResumeStreamResponse = JSON.parseObject(response, ResumeStreamResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(ResumeStreamRequest requestObj) throws Exception {
