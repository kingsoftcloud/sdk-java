...
/**
 * @Classname SetProxyIpClient @Description 支持在云电脑里配置出口代理
 */
@Slf4j
public class SetProxyIpClient extends BaseClient {
  private static final String service = "ked";
  private static final String version = "V1";
  private static final String action = "SetProxyIp";
   ...
   * @throws Exception
   */
  public SetProxyIpResponse doPost(
      String path, SetProxyIpRequest requestObj, Map<String, String> head) throws Exception {
   ...
   * @throws Exception
   */
  public SetProxyIpResponse doPostRaw(
      String path, SetProxyIpRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
    String response = doRpc(path, requestObj, requestHeaders, "post");
   ...
   * @throws Exception
   */
  public SetProxyIpResponse doGet(
      String path, SetProxyIpRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
   ...
   * @throws Exception
   */
  public SetProxyIpResponse doDelete(
      String path, SetProxyIpRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
   ...
   * @throws Exception
   */
  public SetProxyIpResponse doPut(
      String path, SetProxyIpRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
  ...
  private String doRpc(
      String path, SetProxyIpRequest requestObj, Map<String, String> head, String requestMethod)
      throws Exception {
    // 断言
  ...
  private JSONObject getRequestParam(SetProxyIpRequest requestObj, String contentType)
      throws Exception {
    // 请求参数
