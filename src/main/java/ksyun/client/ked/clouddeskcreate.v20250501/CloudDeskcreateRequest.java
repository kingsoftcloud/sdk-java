...
/**
 * @Classname CloudDeskcreateRequest @Description 请求参数
 */
@Data
public class CloudDeskcreateRequest {
  ...
  /**
   * 云电脑类型 4C8G 4C8G_1G 8C16G 8C16G_1G 8C16G_2G 16C16G_2G 16C32G 16C32G_2G 8C16G3060 16C32G3060
   * 16C64G3060
   */
  ...
  /** 计费模式 1: 包年包月 87: 按量付费 5：按量付费（按日月结） */
  ...
  /** gpu类型：0,FPGA,vGPU 1G,vGPU 2G,3060 12G独显,2080Ti 2G 默认是套餐编码对应的gpu */
  @KsYunField(name = "gpu")
  private String Gpu;
