...
/**
 * @Classname DeleteLabelClient @Description 删除一个或多个标签，删除标签后，已绑定过此标签的云桌面上的标签都将被删除
 */
@Slf4j
public class DeleteLabelClient extends BaseClient {
  private static final String service = "ked";
  private static final String version = "V1";
  private static final String action = "DeleteLabel";
   ...
   * @throws Exception
   */
  public DeleteLabelResponse doPost(
      String path, DeleteLabelRequest requestObj, Map<String, String> head) throws Exception {
   ...
   * @throws Exception
   */
  public DeleteLabelResponse doPostRaw(String path, DeleteLabelRequest requestObj)
      throws Exception {
    Map<String, String> head = new HashMap<>();
    head.put("Content-Type", "application/json");
   ...
   * @throws Exception
   */
  public DeleteLabelResponse doPostRaw(
      String path, DeleteLabelRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
    String response = doRpc(path, requestObj, requestHeaders, "post");
   ...
   * @throws Exception
   */
  public DeleteLabelResponse doGet(
      String path, DeleteLabelRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
   ...
   * @throws Exception
   */
  public DeleteLabelResponse doDelete(
      String path, DeleteLabelRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
   ...
   * @throws Exception
   */
  public DeleteLabelResponse doPut(
      String path, DeleteLabelRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
  ...
  private String doRpc(
      String path, DeleteLabelRequest requestObj, Map<String, String> head, String requestMethod)
      throws Exception {
    // 断言
  ...
  private JSONObject getRequestParam(DeleteLabelRequest requestObj, String contentType)
      throws Exception {
    // 请求参数
