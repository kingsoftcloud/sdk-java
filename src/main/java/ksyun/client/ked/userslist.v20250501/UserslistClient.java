...
/**
 * @Classname UserslistClient @Description 查看所有用户的概览信息。
 */
@Slf4j
public class UserslistClient extends BaseClient {
  private static final String service = "ked";
  private static final String version = "V1";
  private static final String action = "Userslist";
   ...
   * @throws Exception
   */
  public UserslistResponse doPost(
      String path, UserslistRequest requestObj, Map<String, String> head) throws Exception {
   ...
   * @throws Exception
   */
  public UserslistResponse doPostRaw(
      String path, UserslistRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    String response = doRpc(path, requestObj, requestHeaders, "post");
   ...
   * @throws Exception
   */
  public UserslistResponse doGet(String path, UserslistRequest requestObj, Map<String, String> head)
      throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public UserslistResponse doDelete(
      String path, UserslistRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public UserslistResponse doPut(String path, UserslistRequest requestObj, Map<String, String> head)
      throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
  ...
  private String doRpc(
      String path, UserslistRequest requestObj, Map<String, String> head, String requestMethod)
      throws Exception {
    // 断言
  ...
  private JSONObject getRequestParam(UserslistRequest requestObj, String contentType)
      throws Exception {
    // 请求参数
