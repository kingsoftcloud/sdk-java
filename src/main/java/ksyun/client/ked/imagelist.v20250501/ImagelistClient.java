...
/**
 * @Classname ImagelistClient @Description 列出所有可用的镜像资源列表。
 */
@Slf4j
public class ImagelistClient extends BaseClient {
  private static final String service = "ked";
  private static final String version = "V1";
  private static final String action = "Imagelist";
   ...
   * @throws Exception
   */
  public ImagelistResponse doPost(
      String path, ImagelistRequest requestObj, Map<String, String> head) throws Exception {
   ...
   * @throws Exception
   */
  public ImagelistResponse doPostRaw(
      String path, ImagelistRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    String response = doRpc(path, requestObj, requestHeaders, "post");
   ...
   * @throws Exception
   */
  public ImagelistResponse doGet(String path, ImagelistRequest requestObj, Map<String, String> head)
      throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public ImagelistResponse doDelete(
      String path, ImagelistRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public ImagelistResponse doPut(String path, ImagelistRequest requestObj, Map<String, String> head)
      throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
  ...
  private String doRpc(
      String path, ImagelistRequest requestObj, Map<String, String> head, String requestMethod)
      throws Exception {
    // 断言
  ...
  private JSONObject getRequestParam(ImagelistRequest requestObj, String contentType)
      throws Exception {
    // 请求参数
