...
public class CloudDeskmanageClient extends BaseClient {
     ...
     * @return CloudDeskmanageResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doPostSend(String path, CloudDeskmanageRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doPostSend(String path, CloudDeskmanageRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doPostSend(String path, CloudDeskmanageRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doPostSend(String path, CloudDeskmanageRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doGetSend(String path, CloudDeskmanageRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doGetSend(String path, CloudDeskmanageRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doGetSend(String path, CloudDeskmanageRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doPutSend(String path, CloudDeskmanageRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doPutSend(String path, CloudDeskmanageRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doPutSend(String path, CloudDeskmanageRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doDeleteSend(String path, CloudDeskmanageRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doDeleteSend(String path, CloudDeskmanageRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CloudDeskmanageResponse doDeleteSend(String path, CloudDeskmanageRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private CloudDeskmanageResponse executeWithV2(String method, String path, CloudDeskmanageRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, CloudDeskmanageResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, CloudDeskmanageRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, CloudDeskmanageRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, CloudDeskmanageRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, CloudDeskmanageRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, CloudDeskmanageRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, CloudDeskmanageRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, CloudDeskmanageRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, CloudDeskmanageRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
    ...
    */
    ...
    /**
         ...
         * @throws Exception
         */
        private String doRpc(String path, CloudDeskmanageRequest requestObj, Map<String, String> head, String requestMethod) throws Exception {
            //断言
        ...
        private JSONObject getRequestParam(CloudDeskmanageRequest requestObj, String contentType) throws Exception {
            //请求参数
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, CloudDeskmanageRequest requestObj, Map<String, String> head,
