...
public class StrategyeditClient extends BaseClient {
    ...
    */
    ...
    public StrategyeditResponse doDelete(String path, StrategyeditRequest requestObj, Map<String, String> head) throws Exception {
        ...
        StrategyeditResponse StrategyeditResponse = JSON.parseObject(response, StrategyeditResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(StrategyeditRequest requestObj) throws Exception {
