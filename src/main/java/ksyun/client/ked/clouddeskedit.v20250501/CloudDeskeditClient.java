...
public class CloudDeskeditClient extends BaseClient {
    ...
    public CloudDeskeditResponse doDelete(String path, CloudDeskeditRequest requestObj, Map<String, String> head) throws Exception {
        ...
        CloudDeskeditResponse CloudDeskeditResponse = JSON.parseObject(response, CloudDeskeditResponse.class);
        return CloudDeskeditResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(CloudDeskeditRequest requestObj) throws Exception {
