...
/**
* @Classname DescribeOrganizationTreeResponse
* @Description DescribeOrganizationTree 返回体
*/
@Data
@ToString
public class DescribeOrganizationTreeResponse extends BaseResponseModel {
