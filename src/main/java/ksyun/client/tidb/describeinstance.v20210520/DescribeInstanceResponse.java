...
public class DescribeInstanceResponse extends BaseResponseModel {
    ...
    public static class DataDto {
        ...
        private List<DataModuleConfigsDto> ModuleConfigs;

        @Data
        @ToString
        public static class DataModuleConfigsDto {
            /**模块名称*/
...
1:正式产品 2:试用产品*/
        ...
        private DataBackupConfigDto BackupConfig;

        @Data
        @ToString
        public static class DataBackupConfigDto {
            /**最大备份记录数*/
