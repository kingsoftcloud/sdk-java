...
public class ListBackupClient extends BaseClient {
    ...
    */
    ...
    public ListBackupResponse doDelete(String path, ListBackupRequest requestObj, Map<String, String> head) throws Exception {
        ...
        ListBackupResponse ListBackupResponse = JSON.parseObject(response, ListBackupResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(ListBackupRequest requestObj) throws Exception {
