...
/**
 * @Classname CreateTaskClient @Description 实例-创建任务(TICDC)
 */
@Slf4j
public class CreateTaskClient extends BaseClient {
  ...
  private static final String action = "CreateTask";
   ...
   * @throws Exception
   */
  public CreateTaskResponse doPost(
      String path, CreateTaskRequest requestObj, Map<String, String> head) throws Exception {
   ...
   * @throws Exception
   */
  public CreateTaskResponse doPostRaw(
      String path, CreateTaskRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
    String response = doRpc(path, requestObj, requestHeaders, "post");
   ...
   * @throws Exception
   */
  public CreateTaskResponse doGet(
      String path, CreateTaskRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
   ...
   * @throws Exception
   */
  public CreateTaskResponse doDelete(
      String path, CreateTaskRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
   ...
   * @throws Exception
   */
  public CreateTaskResponse doPut(
      String path, CreateTaskRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
  ...
  private String doRpc(
      String path, CreateTaskRequest requestObj, Map<String, String> head, String requestMethod)
      throws Exception {
    // 断言
  ...
  private JSONObject getRequestParam(CreateTaskRequest requestObj, String contentType)
      throws Exception {
    // 请求参数
