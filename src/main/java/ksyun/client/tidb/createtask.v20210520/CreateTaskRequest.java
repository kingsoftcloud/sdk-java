...
/**
 * @Classname CreateTaskRequest @Description 请求参数
 */
@Data
public class CreateTaskRequest {
  ...
  /** 目标端VpcId 仅Kafka需要传，Mysql不需要 */
  @KsYunField(name = "VpcId")
  private String VpcId;

  /** 目标端VnetId 仅Kafka需要传，Mysql不需要 */
  @KsYunField(name = "VnetId")
  private String VnetId;

  /** 目标端实例类型 仅支持：MySQLKAFKA */
  @KsYunField(name = "TargetType")
  private String TargetType;

  /** 目标端拓展信息 若TargetType=MySQL，根据需要填写 */
  ...
  public static class TargetMySQLDto {
    ...
    /** 向下游执行SQL的batch大小 默认：256 */
    @KsYunField(name = "MaxTxnRow")
    private Integer MaxTxnRow;
  }

  /** 目标端拓展信息 若TargetType=KAFKA，根据需要填写 */
  ...
  public static class TargetKafkaDto {
    ...
    /** 信息协议：默认:canal-json (default|canal-json|open-protocol|canal|avro|maxwell) */
    @KsYunField(name = "Protocol")
    private String Protocol;

    /** 下游kafka partition数量 默认：3 */
    @KsYunField(name = "PartitionNum")
    private Integer PartitionNum;

    /** 每次向kafka broker 发送消息的最大数据量 默认：10485760 */
