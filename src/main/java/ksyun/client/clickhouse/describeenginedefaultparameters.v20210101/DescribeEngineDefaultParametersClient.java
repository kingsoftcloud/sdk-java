...
* @Description Clickhouse根据版本查询实例默认参数配置
*/
@Slf4j
public class DescribeEngineDefaultParametersClient extends BaseClient {
    ...
    */
    ...
    public DescribeEngineDefaultParametersResponse doDelete(String path, DescribeEngineDefaultParametersRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DescribeEngineDefaultParametersResponse DescribeEngineDefaultParametersResponse = JSON.parseObject(response, DescribeEngineDefaultParametersResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(DescribeEngineDefaultParametersRequest requestObj) throws Exception {
