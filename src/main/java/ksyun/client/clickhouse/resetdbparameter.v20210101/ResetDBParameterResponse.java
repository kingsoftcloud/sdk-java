...
public class ResetDBParameterResponse extends BaseResponseModel {
    ...
    public static class DataDto {
        ...
        private DataConfigurationDto Configuration;

        @Data
        @ToString
        public static class DataConfigurationDto {
            /***/
            ...
            /***/
            @JsonProperty("values")
            private DataConfigurationValuesDto Values;

            @Data
            @ToString
            public static class DataConfigurationValuesDto {
                /***/
