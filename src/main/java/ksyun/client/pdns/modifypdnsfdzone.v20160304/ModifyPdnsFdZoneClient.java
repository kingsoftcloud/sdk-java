...
public class ModifyPdnsFdZoneClient extends BaseClient {
    ...
    public ModifyPdnsFdZoneResponse doDelete(String path, ModifyPdnsFdZoneRequest requestObj, Map<String, String> head) throws Exception {
        ...
        ModifyPdnsFdZoneResponse ModifyPdnsFdZoneResponse = JSON.parseObject(response, ModifyPdnsFdZoneResponse.class);
        return ModifyPdnsFdZoneResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(ModifyPdnsFdZoneRequest requestObj) throws Exception {
