...
public class CreateEndPointClient extends BaseClient {
    ...
    public CreateEndPointResponse doDelete(String path, CreateEndPointRequest requestObj, Map<String, String> head) throws Exception {
        ...
        CreateEndPointResponse CreateEndPointResponse = JSON.parseObject(response, CreateEndPointResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(CreateEndPointRequest requestObj) throws Exception {
