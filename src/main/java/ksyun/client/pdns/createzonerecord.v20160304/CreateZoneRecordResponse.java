...
/**
* @Classname CreateZoneRecordResponse
* @Description CreateZoneRecord 返回体
*/
@Data
@ToString
public class CreateZoneRecordResponse extends BaseResponseModel {
    ...
    public static class RecordDto {
        ...
        private List<RecordDtoRecordDataSetDto> RecordDataSet;

        @Data
        @ToString
        public static class RecordDtoRecordDataSetDto {
            /**记录值*/
