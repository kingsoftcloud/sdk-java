...
public class GetLoginProfileClient extends BaseClient {
    ...
    */
    ...
    public GetLoginProfileResponse doDelete(String path, GetLoginProfileRequest requestObj, Map<String, String> head) throws Exception {
        ...
        GetLoginProfileResponse GetLoginProfileResponse = JSON.parseObject(response, GetLoginProfileResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(GetLoginProfileRequest requestObj) throws Exception {
