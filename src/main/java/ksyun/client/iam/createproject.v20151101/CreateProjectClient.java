...
public class CreateProjectClient extends BaseClient {
    ...
    */
    ...
    public CreateProjectResponse doDelete(String path, CreateProjectRequest requestObj, Map<String, String> head) throws Exception {
        ...
        CreateProjectResponse CreateProjectResponse = JSON.parseObject(response, CreateProjectResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(CreateProjectRequest requestObj) throws Exception {
