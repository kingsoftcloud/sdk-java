...
public class ListGroupPoliciesResponse extends BaseResponseModel {
    ...
    public static class ListGroupPoliciesResultDto {
        ...
        private ListGroupPoliciesResultAttachedPoliciesDto AttachedPolicies;

        @Data
        @ToString
        public static class ListGroupPoliciesResultAttachedPoliciesDto {
            /***/
            @JsonProperty("member")
            private List<ListGroupPoliciesResultAttachedPoliciesMemberDto> Member;

            @Data
            @ToString
            public static class ListGroupPoliciesResultAttachedPoliciesMemberDto {
                /***/
