...
public class ListUsersClient extends BaseClient {
    ...
    */
    ...
    public ListUsersResponse doDelete(String path, ListUsersRequest requestObj, Map<String, String> head) throws Exception {
        ...
        ListUsersResponse ListUsersResponse = JSON.parseObject(response, ListUsersResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(ListUsersRequest requestObj) throws Exception {
