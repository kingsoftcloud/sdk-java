...
/**
 * @Classname ListUsersClient @Description 查询所有子用户的详细信息
 */
@Slf4j
public class ListUsersClient extends BaseClient {
  ...
  private static final String action = "ListUsers";
   ...
   * @throws Exception
   */
  public ListUsersResponse doPost(
      String path, ListUsersRequest requestObj, Map<String, String> head) throws Exception {
   ...
   * @throws Exception
   */
  public ListUsersResponse doPostRaw(
      String path, ListUsersRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    String response = doRpc(path, requestObj, requestHeaders, "post");
   ...
   * @throws Exception
   */
  public ListUsersResponse doGet(String path, ListUsersRequest requestObj, Map<String, String> head)
      throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public ListUsersResponse doDelete(
      String path, ListUsersRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public ListUsersResponse doPut(String path, ListUsersRequest requestObj, Map<String, String> head)
      throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
  ...
  private String doRpc(
      String path, ListUsersRequest requestObj, Map<String, String> head, String requestMethod)
      throws Exception {
    // 断言
  ...
  private JSONObject getRequestParam(ListUsersRequest requestObj, String contentType)
      throws Exception {
    // 请求参数
