...
public class ListGroupsResponse extends BaseResponseModel {
    ...
    public static class ListGroupsResultDto {
        /***/
        @JsonProperty("Groups")
        private ListGroupsResultGroupsDto Groups;

        @Data
        @ToString
        public static class ListGroupsResultGroupsDto {
            /***/
            @JsonProperty("member")
            private List<ListGroupsResultGroupsMemberDto> Member;

            @Data
            @ToString
            public static class ListGroupsResultGroupsMemberDto {
                /***/
