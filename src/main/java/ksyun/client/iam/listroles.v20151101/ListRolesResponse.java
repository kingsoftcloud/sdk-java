...
public class ListRolesResponse extends BaseResponseModel {
    ...
    public static class ListRolesResultDto {
        /***/
        @JsonProperty("Roles")
        private ListRolesResultRolesDto Roles;

        @Data
        @ToString
        public static class ListRolesResultRolesDto {
            /***/
            @JsonProperty("member")
            private List<ListRolesResultRolesMemberDto> Member;

            @Data
            @ToString
            public static class ListRolesResultRolesMemberDto {
                /***/
                @JsonProperty("Path")
                private String Path;
