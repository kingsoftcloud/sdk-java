...
public class GetAccountAllProjectListClient extends BaseClient {
    ...
    public GetAccountAllProjectListResponse doDelete(String path, GetAccountAllProjectListRequest requestObj, Map<String, String> head) throws Exception {
        ...
        GetAccountAllProjectListResponse GetAccountAllProjectListResponse = JSON.parseObject(response, GetAccountAllProjectListResponse.class);
        return GetAccountAllProjectListResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(GetAccountAllProjectListRequest requestObj) throws Exception {
