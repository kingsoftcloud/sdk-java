...
public class CreatePolicyClient extends BaseClient {
     ...
     * @return CreatePolicyResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doPostSend(String path, CreatePolicyRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doPostSend(String path, CreatePolicyRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doPostSend(String path, CreatePolicyRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doPostSend(String path, CreatePolicyRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doGetSend(String path, CreatePolicyRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doGetSend(String path, CreatePolicyRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doGetSend(String path, CreatePolicyRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doPutSend(String path, CreatePolicyRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doPutSend(String path, CreatePolicyRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doPutSend(String path, CreatePolicyRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doDeleteSend(String path, CreatePolicyRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doDeleteSend(String path, CreatePolicyRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public CreatePolicyResponse doDeleteSend(String path, CreatePolicyRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private CreatePolicyResponse executeWithV2(String method, String path, CreatePolicyRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, CreatePolicyResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, CreatePolicyRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, CreatePolicyRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, CreatePolicyRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, CreatePolicyRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, CreatePolicyRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, CreatePolicyRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, CreatePolicyRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, CreatePolicyRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    ...
    */
    ...
    /**
         ...
         * @throws Exception
         */
        private String doRpc(String path, CreatePolicyRequest requestObj, Map<String, String> head, String requestMethod) throws Exception {
            //断言
        ...
        private JSONObject getRequestParam(CreatePolicyRequest requestObj, String contentType) throws Exception {
            //请求参数
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, CreatePolicyRequest requestObj, Map<String, String> head,
