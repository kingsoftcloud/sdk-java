...
public class UpdateVolumeProjectClient extends BaseClient {
    ...
    public UpdateVolumeProjectResponse doDelete(String path, UpdateVolumeProjectRequest requestObj, Map<String, String> head) throws Exception {
        ...
        UpdateVolumeProjectResponse UpdateVolumeProjectResponse = JSON.parseObject(response, UpdateVolumeProjectResponse.class);
        return UpdateVolumeProjectResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(UpdateVolumeProjectRequest requestObj) throws Exception {
