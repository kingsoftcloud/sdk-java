...
public class CenCidrPublishClient extends BaseClient {
    ...
    */
    ...
    public CenCidrPublishResponse doDelete(String path, CenCidrPublishRequest requestObj, Map<String, String> head) throws Exception {
        ...
        CenCidrPublishResponse CenCidrPublishResponse = JSON.parseObject(response, CenCidrPublishResponse.class);
        return CenCidrPublishResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(CenCidrPublishRequest requestObj) throws Exception {
