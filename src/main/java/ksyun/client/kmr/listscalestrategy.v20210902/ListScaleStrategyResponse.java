...
*/
        ...
        private StrategiesInstanceGroupTypesDto InstanceGroupTypes;

        @Data
        @ToString
        public static class StrategiesInstanceGroupTypesDto {
            /**Task节点组的VPC 子网ID*/
...
*/
        ...
        private StrategiesInstanceGroupInfoDto InstanceGroupInfo;

        @Data
        @ToString
        public static class StrategiesInstanceGroupInfoDto {
            /**系统盘类型
...
*/
        @JsonProperty("InstanceGroupInfo")
        private LoadBasedStrategiesInstanceGroupInfoDto InstanceGroupInfo;

        @Data
        @ToString
        public static class LoadBasedStrategiesInstanceGroupInfoDto {
            /**系统盘类型*/
            @JsonProperty("SystemDiskType")
            private String SystemDiskType;
...
*/
        @JsonProperty("InstanceGroupTypes")
        private LoadBasedStrategiesInstanceGroupTypesDto InstanceGroupTypes;

        @Data
        @ToString
        public static class LoadBasedStrategiesInstanceGroupTypesDto {
            /**子网ID*/
            @JsonProperty("VpcSubnetId")
            private String VpcSubnetId;
            ...
            /***/
            @JsonProperty("ResourceTypes")
            private List<LoadBasedStrategiesInstanceGroupTypesResourceTypesDto> ResourceTypes;

            @Data
            @ToString
            public static class LoadBasedStrategiesInstanceGroupTypesResourceTypesDto {
                /**节点组套餐代码
...
*/
        ...
        private LoadBasedStrategiesStatisticsRuleDto StatisticsRule;

        @Data
        @ToString
        public static class LoadBasedStrategiesStatisticsRuleDto {
            /**负载指标
