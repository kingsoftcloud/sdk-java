...
public class ListFlinkJobRunsResponse extends BaseResponseModel {
    ...
    public static class DataDto {
        ...
        private List<DataJobRunsDto> JobRuns;

        @Data
        @ToString
        public static class DataJobRunsDto {
            /**作业ID*/
...
单位：秒*/
            ...
            private DataJobRunsFlinkDeploymentDataDto FlinkDeploymentData;

            @Data
            @ToString
            public static class DataJobRunsFlinkDeploymentDataDto {
                /**作业名称*/
                @JsonProperty("Name")
                private String Name;
