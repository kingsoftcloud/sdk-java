...
public class StartFlinkJobRunResponse extends BaseResponseModel {
    ...
    public static class DataDto {
        ...
        private DataFlinkDeploymentDataDto FlinkDeploymentData;

        @Data
        @ToString
        public static class DataFlinkDeploymentDataDto {
            /***/
            @JsonProperty("Name")
            private String Name;
            ...
            /***/
            @JsonProperty("FlinkDeploymentData")
            private DataFlinkDeploymentDataFlinkDeploymentDataDto FlinkDeploymentData;

            @Data
            @ToString
            public static class DataFlinkDeploymentDataFlinkDeploymentDataDto {
                /**作业名称*/
                @JsonProperty("Name")
                private String Name;
