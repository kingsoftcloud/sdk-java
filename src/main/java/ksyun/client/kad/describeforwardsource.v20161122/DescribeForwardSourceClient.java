...
public class DescribeForwardSourceClient extends BaseClient {
    ...
    public DescribeForwardSourceResponse doDelete(String path, DescribeForwardSourceRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DescribeForwardSourceResponse DescribeForwardSourceResponse = JSON.parseObject(response, DescribeForwardSourceResponse.class);
        return DescribeForwardSourceResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(DescribeForwardSourceRequest requestObj) throws Exception {
