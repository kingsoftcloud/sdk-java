...
public class DescribeAlarmPolicyClient extends BaseClient {
    ...
    */
    ...
    public DescribeAlarmPolicyResponse doDelete(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DescribeAlarmPolicyResponse DescribeAlarmPolicyResponse = JSON.parseObject(response, DescribeAlarmPolicyResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(DescribeAlarmPolicyRequest requestObj) throws Exception {
