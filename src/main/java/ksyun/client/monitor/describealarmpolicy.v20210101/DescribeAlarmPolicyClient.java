...
public class DescribeAlarmPolicyClient extends BaseClient {
    ...
    private final static String action = "DescribeAlarmPolicy";
    ...
    public DescribeAlarmPolicyClient(Credential credential) {
     ...
     * @return DescribeAlarmPolicyResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doPostSend(String path, DescribeAlarmPolicyRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doPostSend(String path, DescribeAlarmPolicyRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doPostSend(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doPostSend(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doGetSend(String path, DescribeAlarmPolicyRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doGetSend(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doGetSend(String path, DescribeAlarmPolicyRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doPutSend(String path, DescribeAlarmPolicyRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doPutSend(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doPutSend(String path, DescribeAlarmPolicyRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doDeleteSend(String path, DescribeAlarmPolicyRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doDeleteSend(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeAlarmPolicyResponse doDeleteSend(String path, DescribeAlarmPolicyRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private DescribeAlarmPolicyResponse executeWithV2(String method, String path, DescribeAlarmPolicyRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, DescribeAlarmPolicyResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, DescribeAlarmPolicyRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, DescribeAlarmPolicyRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, DescribeAlarmPolicyRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, DescribeAlarmPolicyRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @throws Exception
     */
    public DescribeAlarmPolicyResponse doPost(String path, DescribeAlarmPolicyRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
    ...
    public DescribeAlarmPolicyResponse doPost(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) throws Exception {
        ...
        return JSON.parseObject(response, DescribeAlarmPolicyResponse.class);
    }
    ...
    */
     ...
     * @throws Exception
     */
    public DescribeAlarmPolicyResponse doGet(String path, DescribeAlarmPolicyRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
         ...
         * @throws Exception
         */
        public DescribeAlarmPolicyResponse doGet(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) throws Exception {
            final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
            requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @throws Exception
     */
    public DescribeAlarmPolicyResponse doDelete(String path, DescribeAlarmPolicyRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws Exception
     */
    public DescribeAlarmPolicyResponse doDelete(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) throws Exception {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @throws Exception
     */
    public DescribeAlarmPolicyResponse doPut(String path, DescribeAlarmPolicyRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
        head.putIfAbsent("Content-Type", "application/json");
     ...
     * @throws Exception
     */
    public DescribeAlarmPolicyResponse doPut(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head) throws Exception {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
       requestHeaders.putIfAbsent("Content-Type", "application/json");
    ...
    /**
         ...
         * @throws Exception
         */
        private String doRpc(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head, String requestMethod) throws Exception {
            //断言
        ...
        private JSONObject getRequestParam(DescribeAlarmPolicyRequest requestObj, String contentType) throws Exception {
            //请求参数
        ...
        private JSONObject getSimpleRequestParams(DescribeAlarmPolicyRequest requestObj) throws Exception {
        ...
        private JSONObject getPostRawRequestParams(DescribeAlarmPolicyRequest requestObj) throws Exception {
            JSONObject requestParams = new JSONObject();
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, DescribeAlarmPolicyRequest requestObj, Map<String, String> head,
