...
public class DescribeAlarmPolicyResponse extends BaseResponseModel {
    ...
    public static class DataDto {
        ...
        private List<DataAlarmPolicyListDto> AlarmPolicyList;

        @Data
        @ToString
        public static class DataAlarmPolicyListDto {
            /**策略ID*/
...
- 1：禁用*/
            ...
            private List<DataAlarmPolicyListTriggerRuleListDto> TriggerRuleList;

            @Data
            @ToString
            public static class DataAlarmPolicyListTriggerRuleListDto {
                /**规则ID*/
...
连续触发周期。*/
            ...
            private List<DataAlarmPolicyListContactInfoListDto> ContactInfoList;

            @Data
            @ToString
            public static class DataAlarmPolicyListContactInfoListDto {
                /**告警联系人ID或告警联系组ID*/
