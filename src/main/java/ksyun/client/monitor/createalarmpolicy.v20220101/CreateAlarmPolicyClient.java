...
public class CreateAlarmPolicyClient extends BaseClient {
    ...
    public CreateAlarmPolicyResponse doDelete(String path, CreateAlarmPolicyRequest requestObj, Map<String, String> head) throws Exception {
        ...
        CreateAlarmPolicyResponse CreateAlarmPolicyResponse = JSON.parseObject(response, CreateAlarmPolicyResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(CreateAlarmPolicyRequest requestObj) throws Exception {
