...
public class ListMetricsResponse extends BaseResponseModel {
    ...
    public static class ListMetricsResultDto {
        ...
        private ListMetricsResultMetricsDto Metrics;

        @Data
        @ToString
        public static class ListMetricsResultMetricsDto {
            /***/
            @JsonProperty("member")
            private List<ListMetricsResultMetricsMemberDto> Member;

            @Data
            @ToString
            public static class ListMetricsResultMetricsMemberDto {
                /**实例ID。*/
