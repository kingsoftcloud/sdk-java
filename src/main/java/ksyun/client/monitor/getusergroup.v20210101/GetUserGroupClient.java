...
/**
 * @Classname GetUserGroupClient @Description 查询联系组
 */
@Slf4j
public class GetUserGroupClient extends BaseClient {
  ...
  private static final String action = "GetUserGroup";
   ...
   * @throws Exception
   */
  public GetUserGroupResponse doPost(
      String path, GetUserGroupRequest requestObj, Map<String, String> head) throws Exception {
   ...
   * @throws Exception
   */
  public GetUserGroupResponse doPostRaw(String path, GetUserGroupRequest requestObj)
      throws Exception {
    Map<String, String> head = new HashMap<>();
    head.put("Content-Type", "application/json");
   ...
   * @throws Exception
   */
  public GetUserGroupResponse doPostRaw(
      String path, GetUserGroupRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
    String response = doRpc(path, requestObj, requestHeaders, "post");
   ...
   * @throws Exception
   */
  public GetUserGroupResponse doGet(
      String path, GetUserGroupRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
   ...
   * @throws Exception
   */
  public GetUserGroupResponse doDelete(String path, GetUserGroupRequest requestObj)
      throws Exception {
    Map<String, String> head = new HashMap<>();
    head.put("Content-Type", "application/json");
   ...
   * @throws Exception
   */
  public GetUserGroupResponse doDelete(
      String path, GetUserGroupRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
   ...
   * @throws Exception
   */
  public GetUserGroupResponse doPut(
      String path, GetUserGroupRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/json");
  ...
  private String doRpc(
      String path, GetUserGroupRequest requestObj, Map<String, String> head, String requestMethod)
      throws Exception {
    // 断言
  ...
  private JSONObject getRequestParam(GetUserGroupRequest requestObj, String contentType)
      throws Exception {
    // 请求参数
