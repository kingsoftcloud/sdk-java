...
/**
 * @Classname DescribeSysEventGroupListRequest @Description 请求参数
 */
@Data
public class DescribeSysEventGroupListRequest {
  /** 表示一类云产品，指定命名空间, 示例值： - KEC: 云服务器 - KS3：对象存储 */
   ...
   * 起始时间。
   *
   * <p>> **Tips**：请注意时间格式为Unix时间戳（毫秒），从1970年1月1日开始所经过的毫秒数。
   */
