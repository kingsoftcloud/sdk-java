...
/**
 * @Classname DescribeScalingInstanceRequest @Description 请求参数
 */
@Data
public class DescribeScalingInstanceRequest {
  ...
  /** 待查询的与伸缩组绑定的云服务器类型 Auto：表示伸缩组自动创建生成的实例；Manual：表示用户手动创建的实例 */
  @KsYunField(name = "CreationType")
  private String CreationType;

  /** 待查询的与伸缩组绑定的云服务器健康状态 Healthy：表示健康；UnHealthy：表示不健康 */
