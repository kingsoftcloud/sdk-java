...
public class CreateLocalVolumeSnapshotClient extends BaseClient {
    ...
    */
    ...
    public CreateLocalVolumeSnapshotResponse doDelete(String path, CreateLocalVolumeSnapshotRequest requestObj, Map<String, String> head) throws Exception {
        ...
        CreateLocalVolumeSnapshotResponse CreateLocalVolumeSnapshotResponse = JSON.parseObject(response, CreateLocalVolumeSnapshotResponse.class);
        return CreateLocalVolumeSnapshotResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(CreateLocalVolumeSnapshotRequest requestObj) throws Exception {
