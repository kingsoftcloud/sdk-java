...
public class DescribeModelsClient extends BaseClient {
    ...
    */
    ...
    public DescribeModelsResponse doDelete(String path, DescribeModelsRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DescribeModelsResponse DescribeModelsResponse = JSON.parseObject(response, DescribeModelsResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(DescribeModelsRequest requestObj) throws Exception {
