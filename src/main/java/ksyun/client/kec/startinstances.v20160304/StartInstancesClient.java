...
public class StartInstancesClient extends BaseClient {
    ...
    */
    ...
    public StartInstancesResponse doDelete(String path, StartInstancesRequest requestObj, Map<String, String> head) throws Exception {
        ...
        StartInstancesResponse StartInstancesResponse = JSON.parseObject(response, StartInstancesResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(StartInstancesRequest requestObj) throws Exception {
