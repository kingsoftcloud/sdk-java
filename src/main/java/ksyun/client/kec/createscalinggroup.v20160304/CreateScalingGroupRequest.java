...
/**
 * @Classname CreateScalingGroupRequest @Description 请求参数
 */
@Data
public class CreateScalingGroupRequest {
  ...
  /** 期望实例数期望实例数，即伸缩组刚创建时的云服务器数量 0-10,必须在最小伸缩数与最大伸缩数之间 */
  @KsYunField(name = "DesiredCapacity")
  private Integer DesiredCapacity;

  /** 移除策略 有效值：RemoveOldestInstance，表示移除最旧云服务器；RemoveNewestInstance，表示移除最新云服务器 */
