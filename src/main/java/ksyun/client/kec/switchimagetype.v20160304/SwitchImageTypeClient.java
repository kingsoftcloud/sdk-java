...
public class SwitchImageTypeClient extends BaseClient {
    ...
    public SwitchImageTypeResponse doDelete(String path, SwitchImageTypeRequest requestObj, Map<String, String> head) throws Exception {
        ...
        SwitchImageTypeResponse SwitchImageTypeResponse = JSON.parseObject(response, SwitchImageTypeResponse.class);
        return SwitchImageTypeResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(SwitchImageTypeRequest requestObj) throws Exception {
