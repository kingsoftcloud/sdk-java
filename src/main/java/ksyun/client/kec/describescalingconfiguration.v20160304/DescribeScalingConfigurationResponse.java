...
public class DescribeScalingConfigurationResponse extends BaseResponseModel {
    ...
    public static class ScalingConfigurationSetDto {
        ...
        private List<ScalingConfigurationSetScalingGroupIdSetDto> ScalingGroupIdSet;

        @Data
        @ToString
        public static class ScalingConfigurationSetScalingGroupIdSetDto {
            /***/
        ...
        private ScalingConfigurationSetProjectDto Project;

        @Data
        @ToString
        public static class ScalingConfigurationSetProjectDto {
            /***/
        ...
        /***/
        @JsonProperty("TagSet")
        private List<ScalingConfigurationSetTagSetDto> TagSet;

        @Data
        @ToString
        public static class ScalingConfigurationSetTagSetDto {
            /***/
            @JsonProperty("Key")
            private String Key;
        ...
        private List<ScalingConfigurationSetEbsTagSetDto> EbsTagSet;

        @Data
        @ToString
        public static class ScalingConfigurationSetEbsTagSetDto {
            /***/
            @JsonProperty("Key")
            private String Key;
