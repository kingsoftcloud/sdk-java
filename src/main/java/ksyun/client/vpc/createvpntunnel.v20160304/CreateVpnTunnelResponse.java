...
/**
* @Classname CreateVpnTunnelResponse
* @Description CreateVpnTunnel 返回体
*/
@Data
@ToString
public class CreateVpnTunnelResponse extends BaseResponseModel {
    /**请求ID*/
    ...
    private VpnTunnelDto VpnTunnel;

    @Data
    @ToString
    public static class VpnTunnelDto {
        /**创建时间*/
