...
public class DeleteVpnGatewayClient extends BaseClient {
     ...
     * @return DeleteVpnGatewayResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doPostSend(String path, DeleteVpnGatewayRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doPostSend(String path, DeleteVpnGatewayRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doPostSend(String path, DeleteVpnGatewayRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doPostSend(String path, DeleteVpnGatewayRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doGetSend(String path, DeleteVpnGatewayRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doGetSend(String path, DeleteVpnGatewayRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doGetSend(String path, DeleteVpnGatewayRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doPutSend(String path, DeleteVpnGatewayRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doPutSend(String path, DeleteVpnGatewayRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doPutSend(String path, DeleteVpnGatewayRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doDeleteSend(String path, DeleteVpnGatewayRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doDeleteSend(String path, DeleteVpnGatewayRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpnGatewayResponse doDeleteSend(String path, DeleteVpnGatewayRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private DeleteVpnGatewayResponse executeWithV2(String method, String path, DeleteVpnGatewayRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, DeleteVpnGatewayResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, DeleteVpnGatewayRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, DeleteVpnGatewayRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, DeleteVpnGatewayRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, DeleteVpnGatewayRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, DeleteVpnGatewayRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, DeleteVpnGatewayRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, DeleteVpnGatewayRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, DeleteVpnGatewayRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    ...
    * @throws Exception
    */
    public DeleteVpnGatewayResponse doPostRaw(String path, DeleteVpnGatewayRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
    ...
    * @throws Exception
    */
    public DeleteVpnGatewayResponse doPostRaw(String path, DeleteVpnGatewayRequest requestObj, Map<String, String> head) throws Exception {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
        String response = doRpc(path, requestObj, requestHeaders, "post");
        return JSON.parseObject(response, DeleteVpnGatewayResponse.class);
    ...
    /**
         ...
         * @throws Exception
         */
        private String doRpc(String path, DeleteVpnGatewayRequest requestObj, Map<String, String> head, String requestMethod) throws Exception {
            //断言
        ...
        private JSONObject getRequestParam(DeleteVpnGatewayRequest requestObj, String contentType) throws Exception {
            //请求参数
        ...
        private JSONObject getSimpleRequestParams(DeleteVpnGatewayRequest requestObj) throws Exception {
        ...
        private JSONObject getPostRawRequestParams(DeleteVpnGatewayRequest requestObj) throws Exception {
            JSONObject requestParams = new JSONObject();
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, DeleteVpnGatewayRequest requestObj, Map<String, String> head,
