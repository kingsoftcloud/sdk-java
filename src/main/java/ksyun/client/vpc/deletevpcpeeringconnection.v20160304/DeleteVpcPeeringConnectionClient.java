...
public class DeleteVpcPeeringConnectionClient extends BaseClient {
     ...
     * @return DeleteVpcPeeringConnectionResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doPostSend(String path, DeleteVpcPeeringConnectionRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doPostSend(String path, DeleteVpcPeeringConnectionRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doPostSend(String path, DeleteVpcPeeringConnectionRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doPostSend(String path, DeleteVpcPeeringConnectionRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doGetSend(String path, DeleteVpcPeeringConnectionRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doGetSend(String path, DeleteVpcPeeringConnectionRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doGetSend(String path, DeleteVpcPeeringConnectionRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doPutSend(String path, DeleteVpcPeeringConnectionRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doPutSend(String path, DeleteVpcPeeringConnectionRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doPutSend(String path, DeleteVpcPeeringConnectionRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doDeleteSend(String path, DeleteVpcPeeringConnectionRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doDeleteSend(String path, DeleteVpcPeeringConnectionRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DeleteVpcPeeringConnectionResponse doDeleteSend(String path, DeleteVpcPeeringConnectionRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private DeleteVpcPeeringConnectionResponse executeWithV2(String method, String path, DeleteVpcPeeringConnectionRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, DeleteVpcPeeringConnectionResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, DeleteVpcPeeringConnectionRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, DeleteVpcPeeringConnectionRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, DeleteVpcPeeringConnectionRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, DeleteVpcPeeringConnectionRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, DeleteVpcPeeringConnectionRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, DeleteVpcPeeringConnectionRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, DeleteVpcPeeringConnectionRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, DeleteVpcPeeringConnectionRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    ...
    * @throws Exception
    */
    public DeleteVpcPeeringConnectionResponse doPostRaw(String path, DeleteVpcPeeringConnectionRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
    ...
    * @throws Exception
    */
    public DeleteVpcPeeringConnectionResponse doPostRaw(String path, DeleteVpcPeeringConnectionRequest requestObj, Map<String, String> head) throws Exception {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
        String response = doRpc(path, requestObj, requestHeaders, "post");
        return JSON.parseObject(response, DeleteVpcPeeringConnectionResponse.class);
    ...
    /**
         ...
         * @throws Exception
         */
        private String doRpc(String path, DeleteVpcPeeringConnectionRequest requestObj, Map<String, String> head, String requestMethod) throws Exception {
            //断言
        ...
        private JSONObject getRequestParam(DeleteVpcPeeringConnectionRequest requestObj, String contentType) throws Exception {
            //请求参数
        ...
        private JSONObject getSimpleRequestParams(DeleteVpcPeeringConnectionRequest requestObj) throws Exception {
        ...
        private JSONObject getPostRawRequestParams(DeleteVpcPeeringConnectionRequest requestObj) throws Exception {
            JSONObject requestParams = new JSONObject();
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, DeleteVpcPeeringConnectionRequest requestObj, Map<String, String> head,
