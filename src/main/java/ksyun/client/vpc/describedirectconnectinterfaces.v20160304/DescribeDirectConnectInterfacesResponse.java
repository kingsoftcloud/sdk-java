...
public class DescribeDirectConnectInterfacesResponse extends BaseResponseModel {
    ...
    /**连接通道的信息*/
    @JsonProperty("DirectConnectInterfaceSet")
    private List<DirectConnectInterfaceSetDto> DirectConnectInterfaceSet;

    @Data
    @ToString
    public static class DirectConnectInterfaceSetDto {
        /**创建时间*/
