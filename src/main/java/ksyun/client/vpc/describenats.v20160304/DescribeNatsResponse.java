...
public class DescribeNatsResponse extends BaseResponseModel {
    ...
    public static class NatSetDto {
        ...
        @Data
        @ToString
        public static class NatSetNatIpSetDto {
            /**Nat的Ip地址*/
            @JsonProperty("NatIp")
        ...
        private List<NatSetAssociateDirectConnectGatewaySetDto> AssociateDirectConnectGatewaySet;

        @Data
        @ToString
        public static class NatSetAssociateDirectConnectGatewaySetDto {
            /**专线网关的ID*/
        ...
        private List<NatSetAssociateVpnGatewaySetDto> AssociateVpnGatewaySet;

        @Data
        @ToString
        public static class NatSetAssociateVpnGatewaySetDto {
            /**Vpn的ID*/
        ...
        private List<NatSetAssociateInstanceSetDto> AssociateInstanceSet;

        @Data
        @ToString
        public static class NatSetAssociateInstanceSetDto {
            /**私网Ip地址*/
        ...
        private List<NatSetAssociateNatSetDto> AssociateNatSet;

        @Data
        @ToString
        public static class NatSetAssociateNatSetDto {
            /**子网的ID*/
        ...
        private List<NatSetDnatSetDto> DnatSet;

        @Data
        @ToString
        public static class NatSetDnatSetDto {
            /**创建时间*/
            @JsonProperty("CreateTime")
            private String CreateTime;
        ...
        @JsonProperty("TagSet")
        private List<NatSetTagSetDto> TagSet;

        @Data
        @ToString
        public static class NatSetTagSetDto {
            /**资源ID*/
