...
public class QueryNatTopVifMonitorClient extends BaseClient {
    ...
    private final static String action = "QueryNatTopVifMonitor";
    ...
    public QueryNatTopVifMonitorClient(Credential credential) {
     ...
     * @return QueryNatTopVifMonitorResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doPostSend(String path, QueryNatTopVifMonitorRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doPostSend(String path, QueryNatTopVifMonitorRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doPostSend(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doPostSend(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doGetSend(String path, QueryNatTopVifMonitorRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doGetSend(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doGetSend(String path, QueryNatTopVifMonitorRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doPutSend(String path, QueryNatTopVifMonitorRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doPutSend(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doPutSend(String path, QueryNatTopVifMonitorRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doDeleteSend(String path, QueryNatTopVifMonitorRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doDeleteSend(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryNatTopVifMonitorResponse doDeleteSend(String path, QueryNatTopVifMonitorRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private QueryNatTopVifMonitorResponse executeWithV2(String method, String path, QueryNatTopVifMonitorRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, QueryNatTopVifMonitorResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, QueryNatTopVifMonitorRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, QueryNatTopVifMonitorRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, QueryNatTopVifMonitorRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, QueryNatTopVifMonitorRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws Exception
     */
    public QueryNatTopVifMonitorResponse doPost(String path, QueryNatTopVifMonitorRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws Exception
     */
    public QueryNatTopVifMonitorResponse doPost(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head) throws Exception {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    ...
    */
     ...
     * @throws Exception
     */
    public QueryNatTopVifMonitorResponse doGet(String path, QueryNatTopVifMonitorRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
     ...
     * @throws Exception
     */
    public QueryNatTopVifMonitorResponse doDelete(String path, QueryNatTopVifMonitorRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws Exception
     */
    public QueryNatTopVifMonitorResponse doDelete(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head) throws Exception {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws Exception
     */
    public QueryNatTopVifMonitorResponse doPut(String path, QueryNatTopVifMonitorRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
        head.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws Exception
     */
    public QueryNatTopVifMonitorResponse doPut(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head) throws Exception {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
       requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head,
