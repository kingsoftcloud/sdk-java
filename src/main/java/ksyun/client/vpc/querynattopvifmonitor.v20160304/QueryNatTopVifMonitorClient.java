...
public class QueryNatTopVifMonitorClient extends BaseClient {
    ...
    */
    ...
    public QueryNatTopVifMonitorResponse doDelete(String path, QueryNatTopVifMonitorRequest requestObj, Map<String, String> head) throws Exception {
        ...
        QueryNatTopVifMonitorResponse QueryNatTopVifMonitorResponse = JSON.parseObject(response, QueryNatTopVifMonitorResponse.class);
        return QueryNatTopVifMonitorResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(QueryNatTopVifMonitorRequest requestObj) throws Exception {
