...
/**
* @Classname DescribeHaVipResponse
* @Description DescribeHaVip 返回体
*/
@Data
@ToString
public class DescribeHaVipResponse extends BaseResponseModel {
    /**请求ID*/
    ...
    private List<HaVipSetDto> HaVipSet;

    @Data
    @ToString
    public static class HaVipSetDto {
        /**高可用虚拟IP的ID*/
