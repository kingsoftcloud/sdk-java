...
public class DescribeDirectConnectGatewaysResponse extends BaseResponseModel {
    ...
    private List<DirectConnectGatewaySetDto> DirectConnectGatewaySet;

    @Data
    @ToString
    public static class DirectConnectGatewaySetDto {
        /**创建时间*/
        ...
        private List<DirectConnectGatewaySetDirectConnectInterfaceInfoSetDto> DirectConnectInterfaceInfoSet;

        @Data
        @ToString
        public static class DirectConnectGatewaySetDirectConnectInterfaceInfoSetDto {
            /**连接通道的ID*/
            @JsonProperty("DirectConnectInterfaceId")
            private String DirectConnectInterfaceId;
