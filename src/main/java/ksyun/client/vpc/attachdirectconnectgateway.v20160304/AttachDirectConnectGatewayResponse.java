...
public class AttachDirectConnectGatewayResponse extends BaseResponseModel {
    ...
    public static class DirectConnectGatewayDto {
        ...
        private List<DirectConnectGatewayDirectConnectInterfaceInfoSetDto> DirectConnectInterfaceInfoSet;

        @Data
        @ToString
        public static class DirectConnectGatewayDirectConnectInterfaceInfoSetDto {
            /**连接通道的ID*/
            @JsonProperty("DirectConnectInterfaceId")
            private String DirectConnectInterfaceId;
