...
public class DescribeVpcPeeringConnectionsResponse extends BaseResponseModel {
    ...
    /**对等连接的信息*/
    @JsonProperty("VpcPeeringConnectionSet")
    private List<VpcPeeringConnectionSetDto> VpcPeeringConnectionSet;

    @Data
    @ToString
    public static class VpcPeeringConnectionSetDto {
        /**创建时间*/
        ...
        private VpcPeeringConnectionSetRequesterVpcInfoDto RequesterVpcInfo;

        @Data
        @ToString
        public static class VpcPeeringConnectionSetRequesterVpcInfoDto {
            /**发起端账号ID*/
        ...
        private VpcPeeringConnectionSetAccepterVpcInfoDto AccepterVpcInfo;

        @Data
        @ToString
        public static class VpcPeeringConnectionSetAccepterVpcInfoDto {
            /**接受端账号ID*/
            @JsonProperty("AccountId")
            private String AccountId;
