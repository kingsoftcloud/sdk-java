...
public class DescribeNetworkInterfacesResponse extends BaseResponseModel {
    ...
    public static class NetworkInterfaceSetDto {
        ...
        private List<NetworkInterfaceSetAssignedPrivateIpAddressSetDto> AssignedPrivateIpAddressSet;

        @Data
        @ToString
        public static class NetworkInterfaceSetAssignedPrivateIpAddressSetDto {
            /**私网IP地址*/
            @JsonProperty("PrivateIpAddress")
            private String PrivateIpAddress;
        ...
        private List<NetworkInterfaceSetSecurityGroupSetDto> SecurityGroupSet;

        @Data
        @ToString
        public static class NetworkInterfaceSetSecurityGroupSetDto {
            /**安全组ID*/
            @JsonProperty("SecurityGroupId")
            private String SecurityGroupId;
        ...
        private List<NetworkInterfaceSetIpv6PublicIpAddressSetDto> Ipv6PublicIpAddressSet;

        @Data
        @ToString
        public static class NetworkInterfaceSetIpv6PublicIpAddressSetDto {
            /**Ipv6地址*/
