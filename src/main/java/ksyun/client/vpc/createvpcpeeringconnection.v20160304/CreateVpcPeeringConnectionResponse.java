...
/**
* @Classname CreateVpcPeeringConnectionResponse
* @Description CreateVpcPeeringConnection 返回体
*/
@Data
@ToString
public class CreateVpcPeeringConnectionResponse extends BaseResponseModel {
    ...
    public static class VpcPeeringConnectionDto {
        ...
        private VpcPeeringConnectionRequesterVpcInfoDto RequesterVpcInfo;

        @Data
        @ToString
        public static class VpcPeeringConnectionRequesterVpcInfoDto {
            /**发起端账号ID*/
        ...
        private VpcPeeringConnectionAccepterVpcInfoDto AccepterVpcInfo;

        @Data
        @ToString
        public static class VpcPeeringConnectionAccepterVpcInfoDto {
            /**接受端账号ID*/
            @JsonProperty("AccountId")
            private String AccountId;
