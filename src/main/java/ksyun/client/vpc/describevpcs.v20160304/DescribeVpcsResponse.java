...
public class DescribeVpcsResponse extends BaseResponseModel {
    ...
    public static class VpcSetDto {
        ...
        private List<VpcSetIpv6CidrBlockAssociationSetDto> Ipv6CidrBlockAssociationSet;

        @Data
        @ToString
        public static class VpcSetIpv6CidrBlockAssociationSetDto {
            /**Vpc Ipv6的网络范围*/
        ...
        private List<VpcSetSecondaryCidrSetDto> SecondaryCidrSet;

        @Data
        @ToString
        public static class VpcSetSecondaryCidrSetDto {
            /**附加网段ID*/
