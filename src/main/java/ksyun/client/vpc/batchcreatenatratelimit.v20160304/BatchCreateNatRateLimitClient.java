...
public class BatchCreateNatRateLimitClient extends BaseClient {
    ...
    public BatchCreateNatRateLimitResponse doDelete(String path, BatchCreateNatRateLimitRequest requestObj, Map<String, String> head) throws Exception {
        ...
        BatchCreateNatRateLimitResponse BatchCreateNatRateLimitResponse = JSON.parseObject(response, BatchCreateNatRateLimitResponse.class);
        return BatchCreateNatRateLimitResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(BatchCreateNatRateLimitRequest requestObj) throws Exception {
