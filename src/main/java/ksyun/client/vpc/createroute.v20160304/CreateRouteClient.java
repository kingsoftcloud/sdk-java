...
public class CreateRouteClient extends BaseClient {
    ...
    public CreateRouteResponse doDelete(String path, CreateRouteRequest requestObj, Map<String, String> head) throws Exception {
        ...
        CreateRouteResponse CreateRouteResponse = JSON.parseObject(response, CreateRouteResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(CreateRouteRequest requestObj) throws Exception {
