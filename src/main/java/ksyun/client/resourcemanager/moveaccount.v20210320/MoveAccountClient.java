...
/**
 * @Classname MoveAccountClient @Description 移动成员到其他资源夹
 */
@Slf4j
public class MoveAccountClient extends BaseClient {
  ...
  private static final String action = "MoveAccount";
   ...
   * @throws Exception
   */
  public MoveAccountResponse doPost(
      String path, MoveAccountRequest requestObj, Map<String, String> head) throws Exception {
   ...
   * @throws Exception
   */
  public MoveAccountResponse doPostRaw(String path, MoveAccountRequest requestObj)
      throws Exception {
    Map<String, String> head = new HashMap<>();
    head.put("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public MoveAccountResponse doPostRaw(
      String path, MoveAccountRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    String response = doRpc(path, requestObj, requestHeaders, "post");
   ...
   * @throws Exception
   */
  public MoveAccountResponse doGet(
      String path, MoveAccountRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public MoveAccountResponse doDelete(
      String path, MoveAccountRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public MoveAccountResponse doPut(
      String path, MoveAccountRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
  ...
  private String doRpc(
      String path, MoveAccountRequest requestObj, Map<String, String> head, String requestMethod)
      throws Exception {
    // 断言
  ...
  private JSONObject getRequestParam(MoveAccountRequest requestObj, String contentType)
      throws Exception {
    // 请求参数
