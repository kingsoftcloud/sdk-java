...
public class ClusterHealthStatisticResponse extends BaseResponseModel {
    ...
    public static class DataDto {
        ...
        private List<DataHealthCheckHistoryDto> HealthCheckHistory;

        @Data
        @ToString
        public static class DataHealthCheckHistoryDto {
            /**诊断时间*/
            ...
            /***/
            @JsonProperty("Status")
            private List<DataHealthCheckHistoryStatusDto> Status;

            @Data
            @ToString
            public static class DataHealthCheckHistoryStatusDto {
                /**诊断项*/
                @JsonProperty("Item")
                private String Item;
