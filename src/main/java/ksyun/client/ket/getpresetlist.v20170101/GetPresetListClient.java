...
public class GetPresetListClient extends BaseClient {
    ...
    public GetPresetListResponse doDelete(String path, GetPresetListRequest requestObj, Map<String, String> head) throws Exception {
        ...
        GetPresetListResponse GetPresetListResponse = JSON.parseObject(response, GetPresetListResponse.class);
        return GetPresetListResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(GetPresetListRequest requestObj) throws Exception {
