...
public class ModifyPolicyClient extends BaseClient {
    ...
    public ModifyPolicyResponse doDelete(String path, ModifyPolicyRequest requestObj, Map<String, String> head) throws Exception {
        ...
        ModifyPolicyResponse ModifyPolicyResponse = JSON.parseObject(response, ModifyPolicyResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(ModifyPolicyRequest requestObj) throws Exception {
