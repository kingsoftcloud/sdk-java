...
/**
 * @Classname ModifyPolicyClient @Description 修改策略
 */
@Slf4j
public class ModifyPolicyClient extends BaseClient {
  ...
  private static final String action = "ModifyPolicy";
   ...
   * @throws Exception
   */
  public ModifyPolicyResponse doPost(
      String path, ModifyPolicyRequest requestObj, Map<String, String> head) throws Exception {
   ...
   * @throws Exception
   */
  public ModifyPolicyResponse doPostRaw(String path, ModifyPolicyRequest requestObj)
      throws Exception {
    Map<String, String> head = new HashMap<>();
    head.put("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public ModifyPolicyResponse doPostRaw(
      String path, ModifyPolicyRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    String response = doRpc(path, requestObj, requestHeaders, "post");
   ...
   * @throws Exception
   */
  public ModifyPolicyResponse doGet(
      String path, ModifyPolicyRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public ModifyPolicyResponse doDelete(String path, ModifyPolicyRequest requestObj)
      throws Exception {
    Map<String, String> head = new HashMap<>();
    head.put("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public ModifyPolicyResponse doDelete(
      String path, ModifyPolicyRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public ModifyPolicyResponse doPut(
      String path, ModifyPolicyRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
  ...
  private String doRpc(
      String path, ModifyPolicyRequest requestObj, Map<String, String> head, String requestMethod)
      throws Exception {
    // 断言
  ...
  private JSONObject getRequestParam(ModifyPolicyRequest requestObj, String contentType)
      throws Exception {
    // 请求参数
