...
public class GetZoneListClient extends BaseClient {
    ...
    public GetZoneListResponse doDelete(String path, GetZoneListRequest requestObj, Map<String, String> head) throws Exception {
        ...
        GetZoneListResponse GetZoneListResponse = JSON.parseObject(response, GetZoneListResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(GetZoneListRequest requestObj) throws Exception {
