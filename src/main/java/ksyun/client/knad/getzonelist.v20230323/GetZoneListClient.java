...
/**
* @Classname GetZoneListClient
* @Description 获取地理位置列表*/
@Slf4j
public class GetZoneListClient extends BaseClient {
    private final static String service = "knad";
    private final static String version = "2023-03-23";
    private final static String action = "GetZoneList";
    ...
    public GetZoneListClient(Credential credential) {
     ...
     * @return GetZoneListResponse 响应对象
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetZoneListResponse doPostSend(String path, GetZoneListRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetZoneListResponse doPostSend(String path, GetZoneListRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetZoneListResponse doPostSend(String path, GetZoneListRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetZoneListResponse doGetSend(String path, GetZoneListRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetZoneListResponse doGetSend(String path, GetZoneListRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetZoneListResponse doPutSend(String path, GetZoneListRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetZoneListResponse doPutSend(String path, GetZoneListRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetZoneListResponse doDeleteSend(String path, GetZoneListRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetZoneListResponse doDeleteSend(String path, GetZoneListRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
    ...
    private GetZoneListResponse executeWithV2(String method, String path, GetZoneListRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, GetZoneListResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
    ...
    */
    ...
    /**
         ...
         * @throws Exception
         */
        private String doRpc(String path, GetZoneListRequest requestObj, Map<String, String> head, String requestMethod) throws Exception {
            //断言
        ...
        private JSONObject getRequestParam(GetZoneListRequest requestObj, String contentType) throws Exception {
            //请求参数
        ...
        private JSONObject getSimpleRequestParams(GetZoneListRequest requestObj) throws Exception {
        ...
        private JSONObject getPostRawRequestParams(GetZoneListRequest requestObj) throws Exception {
            JSONObject requestParams = new JSONObject();
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, GetZoneListRequest requestObj, Map<String, String> head,
