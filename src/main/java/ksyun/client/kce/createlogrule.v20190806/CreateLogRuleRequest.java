...
/**
 * @Classname CreateLogRuleRequest @Description 请求参数
 */
@Data
public class CreateLogRuleRequest {
  ...
  /** 日志规则名称 - 不超过40个字符，只能包含小写字母、数字及分隔符("-"、"_"、".")，且必须以小写字母、数字开头和结尾 */
  ...
  public static class InputConfigDto {
    /** 日志类型 - 1：容器标准输出 - 2：容器文件路径 - 3：主机文件路径 */
    ...
    public static class ContainerStandoutDto {
      ...
      /** 指定负载采集 - 如果 AllContainer 为false，SpecifiedWorkload 或 SpecifiedPodLabel 必须指定一项 */
      ...
      /** 指定PodLable采集 - 如果 AllContainer 为false，SpecifiedWorkload 或 SpecifiedPodLabel 必须指定一项 */
      ...
      public static class SpecifiedPodLabelDto {
        /** 选择命名空间方式，有效值：1、2 - 1：指定命名空间 - 2：排除命名空间 */
        ...
        /** 容器名称操作类型，如果ContainerName不为空，则该值为必填项。有效值：1、2 - 1：包含 - 2：不包含 */
    ...
    public static class ContainerFileDto {
      ...
      public static class SpecifiedContainerDto {
        ...
        /** 负载类型 - Deployment - DaemonSet - StatefulSet - Job */
