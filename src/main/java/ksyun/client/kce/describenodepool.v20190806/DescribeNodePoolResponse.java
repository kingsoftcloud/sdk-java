...
- updating*/
        ...
        private NodePoolSetNodeTemplateDto NodeTemplate;

        @Data
        @ToString
        public static class NodePoolSetNodeTemplateDto {
            /**计费方式*/
            ...
            private NodePoolSetNodeTemplateSystemDiskDto SystemDisk;

            @Data
            @ToString
            public static class NodePoolSetNodeTemplateSystemDiskDto {
                /**系统盘类型*/
            ...
            private NodePoolSetNodeTemplateDataDiskDto DataDisk;

            @Data
            @ToString
            public static class NodePoolSetNodeTemplateDataDiskDto {
                /**数据盘类型*/
                @JsonProperty("DiskType")
                private String DiskType;
            ...
            private NodePoolSetNodeTemplateAdvancedSettingDto AdvancedSetting;

            @Data
            @ToString
            public static class NodePoolSetNodeTemplateAdvancedSettingDto {
                /**数据盘挂载设置，仅针对于第一块数据盘生效   */
                @JsonProperty("DataDisk")
                private NodePoolSetNodeTemplateAdvancedSettingDataDiskDto DataDisk;

                @Data
                @ToString
                public static class NodePoolSetNodeTemplateAdvancedSettingDataDiskDto {
                ...
                /**节点加入集群时预置的标签*/
                @JsonProperty("Label")
                private List<NodePoolSetNodeTemplateAdvancedSettingLabelDto> Label;

                @Data
                @ToString
                public static class NodePoolSetNodeTemplateAdvancedSettingLabelDto {
                ...
                private NodePoolSetNodeTemplateAdvancedSettingExtraArgDto ExtraArg;

                @Data
                @ToString
                public static class NodePoolSetNodeTemplateAdvancedSettingExtraArgDto {
                    /**自定义节点上k8s组件的参数*/
                    @JsonProperty("Kubelet")
                    private List<NodePoolSetNodeTemplateAdvancedSettingExtraArgKubeletDto> Kubelet;

                    @Data
                    @ToString
                    public static class NodePoolSetNodeTemplateAdvancedSettingExtraArgKubeletDto {
                        /**自定义节点上k8s组件的参数*/
                ...
                /**节点加入集群时预置污点 */
                @JsonProperty("Taints")
                private List<NodePoolSetNodeTemplateAdvancedSettingTaintsDto> Taints;

                @Data
                @ToString
                public static class NodePoolSetNodeTemplateAdvancedSettingTaintsDto {
            ...
            private List<NodePoolSetNodeTemplateEbsTagsDto> EbsTags;

            @Data
            @ToString
            public static class NodePoolSetNodeTemplateEbsTagsDto {
                /**标签键*/
                @JsonProperty("Key")
                private String Key;
            ...
            private List<NodePoolSetNodeTemplateInstanceTagsDto> InstanceTags;

            @Data
            @ToString
            public static class NodePoolSetNodeTemplateInstanceTagsDto {
        ...
        /**节点标签*/
        @JsonProperty("Labels")
        private List<NodePoolSetLabelsDto> Labels;

        @Data
        @ToString
        public static class NodePoolSetLabelsDto {
            /**标签键*/
            @JsonProperty("Key")
            private String Key;
        ...
        /**节点污点*/
        @JsonProperty("Taints")
        private List<NodePoolSetTaintsDto> Taints;

        @Data
        @ToString
        public static class NodePoolSetTaintsDto {
            /**污点名称*/
            @JsonProperty("Key")
            private String Key;
