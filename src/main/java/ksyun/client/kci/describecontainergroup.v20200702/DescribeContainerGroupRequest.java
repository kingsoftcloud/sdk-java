...
/**
 * @Classname DescribeContainerGroupRequest @Description 请求参数
 */
@Data
public class DescribeContainerGroupRequest {
  ...
  /**
   * 支持的过滤筛选条件如下： - subnet-id - vpc-id - availability-zone.name、 - status
   *
   * <p>status常用值范围 - 未知Unknown - ImagePulling - Running - Failed - Succeeded
   */
