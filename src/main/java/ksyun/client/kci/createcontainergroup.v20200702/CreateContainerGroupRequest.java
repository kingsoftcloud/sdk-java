...
/**
 * @Classname CreateContainerGroupRequest @Description 请求参数
 */
@Data
public class CreateContainerGroupRequest {
  ...
  /** EIP实例ID(多值传参用法)， MultiEipAllocationId 和 EipAllocationId只能同时传一个 */
  ...
  public static class AdvanceSettingsDto {
    ...
    public static class SystemDiskDto {
      /**
       * 支持以下几种类型- Local_SSD 本地SSD- SSD3.0 云盘SSD3.0- EHDD 高效云盘- ESSD_SYSTEM_PL0 极速盘- ESSD_SYSTEM_PL1
       * 极速盘- ESSD_SYSTEM_PL2 极速盘请谨慎指定系统盘类型，系统盘类型需要机型的支持
       */
      @KsYunField(name = "Type")
      private String Type;

      /**
       * 系统盘大小范围，当填写了Type，不填写Size时，盘大小默认为最小值Local_SSD 20~100SSD 20~500EHDD 20~500ESSD_SYSTEM_PL0
       * 50~500ESSD_SYSTEM_PL1 50~500ESSD_SYSTEM_PL2 461~500
       */
  ...
  public static class VolumeDto {
    /** Volume类型 - EBSVolume - NFSVolume - HostPathVolume - EmptyDirVolume - ConfigFileVolume */
    @KsYunField(name = "Type")
    private String Type;
    ...
    public static class EBSVolumeDto {
      ...
      /**
       * 当VolumeId为空时，数据盘大小必填，大小范围如下(单位GB)- SSD3.0 10~32000- EHDD 10~32000- ESSD_PL0 40~32000-
       * ESSD_PL1 40~32000- ESSD_PL2 461~32000
       */
      @KsYunField(name = "Size")
      private Integer Size;
    ...
    public static class ConfigFileVolumeDto {
       ...
       *
       * <p>例如0644表示权限为-rw-r--r--，0对应-，表示文件类型为普通文件，644对应后续9位字符，表示3组权限，即用户权限为rw-，用户所在组权限为r--，其他用户权限为r--。
       *
       * <p>权限说明如下：
       *
       * <p>---：没有任何权限，八进制值为0。
       ...
       * <p>-w-：只有写入权限，八进制值为2。
       *
       * <p>-wx：有写入和执行权限，八进制值为3。
       *
       * <p>r--：只有读取权限，八进制值为4。
       *
       * <p>r-x：有读取和执行权限，八进制值为5。
       *
       * <p>rw-：有读取和写入权限，八进制值为6。
       *
       * <p>rwx：具有读取、写入和执行权限，八进制值为7。
       */
  ...
  public static class DataDiskDto {
     ...
     * 云盘类型，创建ebs盘时，必填。
     *
     * <p>- SSD3.0 - EHDD - ESSD_PL0 - ESSD_PL1 - ESSD_PL2
     */
    @KsYunField(name = "Type")
    private String Type;
     ...
     *
     * <p>- SSD3.0 10~32000 - EHDD 10~32000 - ESSD_PL0 40~32000 - ESSD_PL1 40~32000 - ESSD_PL2
     * 461~32000
     */
    @KsYunField(name = "Size")
    private Integer Size;
