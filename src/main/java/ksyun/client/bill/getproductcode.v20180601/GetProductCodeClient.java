...
public class GetProductCodeClient extends BaseClient {
    ...
    public GetProductCodeResponse doDelete(String path, GetProductCodeRequest requestObj, Map<String, String> head) throws Exception {
        ...
        GetProductCodeResponse GetProductCodeResponse = JSON.parseObject(response, GetProductCodeResponse.class);
        return GetProductCodeResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(GetProductCodeRequest requestObj) throws Exception {
