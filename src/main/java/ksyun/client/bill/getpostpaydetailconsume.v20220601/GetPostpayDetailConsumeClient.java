...
public class GetPostpayDetailConsumeClient extends BaseClient {
     ...
     * @return GetPostpayDetailConsumeResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doPostSend(String path, GetPostpayDetailConsumeRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doPostSend(String path, GetPostpayDetailConsumeRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doPostSend(String path, GetPostpayDetailConsumeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doPostSend(String path, GetPostpayDetailConsumeRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doGetSend(String path, GetPostpayDetailConsumeRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doGetSend(String path, GetPostpayDetailConsumeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doGetSend(String path, GetPostpayDetailConsumeRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doPutSend(String path, GetPostpayDetailConsumeRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doPutSend(String path, GetPostpayDetailConsumeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doPutSend(String path, GetPostpayDetailConsumeRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doDeleteSend(String path, GetPostpayDetailConsumeRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doDeleteSend(String path, GetPostpayDetailConsumeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public GetPostpayDetailConsumeResponse doDeleteSend(String path, GetPostpayDetailConsumeRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private GetPostpayDetailConsumeResponse executeWithV2(String method, String path, GetPostpayDetailConsumeRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, GetPostpayDetailConsumeResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, GetPostpayDetailConsumeRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, GetPostpayDetailConsumeRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, GetPostpayDetailConsumeRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, GetPostpayDetailConsumeRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, GetPostpayDetailConsumeRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, GetPostpayDetailConsumeRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, GetPostpayDetailConsumeRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, GetPostpayDetailConsumeRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
    ...
    * @throws Exception
    */
    public GetPostpayDetailConsumeResponse doPostRaw(String path, GetPostpayDetailConsumeRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
    ...
    * @throws Exception
    */
    public GetPostpayDetailConsumeResponse doPostRaw(String path, GetPostpayDetailConsumeRequest requestObj, Map<String, String> head) throws Exception {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
        String response = doRpc(path, requestObj, requestHeaders, "post");
        return JSON.parseObject(response, GetPostpayDetailConsumeResponse.class);
    ...
    /**
         ...
         * @throws Exception
         */
        private String doRpc(String path, GetPostpayDetailConsumeRequest requestObj, Map<String, String> head, String requestMethod) throws Exception {
            //断言
        ...
        private JSONObject getRequestParam(GetPostpayDetailConsumeRequest requestObj, String contentType) throws Exception {
            //请求参数
        ...
        private JSONObject getSimpleRequestParams(GetPostpayDetailConsumeRequest requestObj) throws Exception {
        ...
        private JSONObject getPostRawRequestParams(GetPostpayDetailConsumeRequest requestObj) throws Exception {
            JSONObject requestParams = new JSONObject();
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, GetPostpayDetailConsumeRequest requestObj, Map<String, String> head,
