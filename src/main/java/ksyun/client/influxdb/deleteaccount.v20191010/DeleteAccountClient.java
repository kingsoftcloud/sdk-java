...
public class DeleteAccountClient extends BaseClient {
    ...
    public DeleteAccountResponse doDelete(String path, DeleteAccountRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DeleteAccountResponse DeleteAccountResponse = JSON.parseObject(response, DeleteAccountResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(DeleteAccountRequest requestObj) throws Exception {
