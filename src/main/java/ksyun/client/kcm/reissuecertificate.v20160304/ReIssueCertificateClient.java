...
public class ReIssueCertificateClient extends BaseClient {
    ...
    public ReIssueCertificateResponse doDelete(String path, ReIssueCertificateRequest requestObj, Map<String, String> head) throws Exception {
        ...
        ReIssueCertificateResponse ReIssueCertificateResponse = JSON.parseObject(response, ReIssueCertificateResponse.class);
        return ReIssueCertificateResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(ReIssueCertificateRequest requestObj) throws Exception {
