...
/**
 * @Classname DescribeAddressesRequest @Description 请求参数
 */
@Data
public class DescribeAddressesRequest {
  ...
  public static class FilterDto {
    /**
     * 有效值： - network-interface-id，网卡ID - instance-type(Slb|Ipfwd|Havip)，弹性IP绑定的实例类型 -
     * band-width-share-id，共享带宽ID - line-id，线路的ID - public-ip，弹性IP的地址
     */
