...
public class DescribeNamespaceClient extends BaseClient {
    ...
    public DescribeNamespaceResponse doDelete(String path, DescribeNamespaceRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DescribeNamespaceResponse DescribeNamespaceResponse = JSON.parseObject(response, DescribeNamespaceResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(DescribeNamespaceRequest requestObj) throws Exception {
