...
/**
 * @Classname UpdateRetentionRuleRequest @Description 请求参数
 */
@Data
public class UpdateRetentionRuleRequest {
  ...
  public static class RuleDto {
     ...
     *
     * <p>保留策略为镜像数量时，Template
     * =latestPushedK/latestPulledN/nDaysSinceLastPush/nDaysSinceLastPull，分别对应“保留最新推送的#个镜像”，“保留最新拉取的#个镜像”，“保留最近#天推送的镜像”，“保留最近#天拉取的镜像”
     */
