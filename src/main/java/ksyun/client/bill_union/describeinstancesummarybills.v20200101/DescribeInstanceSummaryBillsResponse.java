...
public class DescribeInstanceSummaryBillsResponse extends BaseResponseModel {
    ...
    public static class SummaryOverviewDto {
        ...
        private List<SummaryOverviewConfigSetDto> ConfigSet;

        @Data
        @ToString
        public static class SummaryOverviewConfigSetDto {
            /**表示数据的key*/
            @JsonProperty("Key")
            private String Key;
        ...
        private List<SummaryOverviewProviderSetDto> ProviderSet;

        @Data
        @ToString
        public static class SummaryOverviewProviderSetDto {
            /**表示数据的key*/
            @JsonProperty("Key")
            private String Key;
        ...
        private List<SummaryOverviewExtraSetDto> ExtraSet;

        @Data
        @ToString
        public static class SummaryOverviewExtraSetDto {
            /**表示数据的key*/
            @JsonProperty("Key")
            private String Key;
        ...
        /**tag信息。 无值不返回*/
        @JsonProperty("TagSet")
        private List<SummaryOverviewTagSetDto> TagSet;

        @Data
        @ToString
        public static class SummaryOverviewTagSetDto {
            /**表示数据的key*/
            @JsonProperty("Key")
            private String Key;
