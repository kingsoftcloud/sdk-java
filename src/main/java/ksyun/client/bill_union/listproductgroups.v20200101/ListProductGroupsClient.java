...
public class ListProductGroupsClient extends BaseClient {
    ...
    public ListProductGroupsResponse doDelete(String path, ListProductGroupsRequest requestObj, Map<String, String> head) throws Exception {
        ...
        ListProductGroupsResponse ListProductGroupsResponse = JSON.parseObject(response, ListProductGroupsResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(ListProductGroupsRequest requestObj) throws Exception {
