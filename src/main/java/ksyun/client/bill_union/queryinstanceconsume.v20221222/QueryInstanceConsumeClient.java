...
public class QueryInstanceConsumeClient extends BaseClient {
    ...
    public QueryInstanceConsumeResponse doDelete(String path, QueryInstanceConsumeRequest requestObj, Map<String, String> head) throws Exception {
        ...
        QueryInstanceConsumeResponse QueryInstanceConsumeResponse = JSON.parseObject(response, QueryInstanceConsumeResponse.class);
        return QueryInstanceConsumeResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(QueryInstanceConsumeRequest requestObj) throws Exception {
