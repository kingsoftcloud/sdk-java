...
/**
* @Classname QueryInstanceConsumeClient
* @Description 查询实例按日汇总账单*/
@Slf4j
public class QueryInstanceConsumeClient extends BaseClient {
    private final static String service = "bill-union";
    private final static String version = "2022-12-22";
    private final static String action = "QueryInstanceConsume";
    ...
    public QueryInstanceConsumeClient(Credential credential) {
     ...
     * @return QueryInstanceConsumeResponse 响应对象
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryInstanceConsumeResponse doPostSend(String path, QueryInstanceConsumeRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryInstanceConsumeResponse doPostSend(String path, QueryInstanceConsumeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryInstanceConsumeResponse doPostSend(String path, QueryInstanceConsumeRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryInstanceConsumeResponse doGetSend(String path, QueryInstanceConsumeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryInstanceConsumeResponse doGetSend(String path, QueryInstanceConsumeRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryInstanceConsumeResponse doPutSend(String path, QueryInstanceConsumeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryInstanceConsumeResponse doPutSend(String path, QueryInstanceConsumeRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryInstanceConsumeResponse doDeleteSend(String path, QueryInstanceConsumeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public QueryInstanceConsumeResponse doDeleteSend(String path, QueryInstanceConsumeRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
    ...
    private QueryInstanceConsumeResponse executeWithV2(String method, String path, QueryInstanceConsumeRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, QueryInstanceConsumeResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
    ...
    */
    ...
    /**
         ...
         * @throws Exception
         */
        private String doRpc(String path, QueryInstanceConsumeRequest requestObj, Map<String, String> head, String requestMethod) throws Exception {
            //断言
        ...
        private JSONObject getRequestParam(QueryInstanceConsumeRequest requestObj, String contentType) throws Exception {
            //请求参数
        ...
        private JSONObject getSimpleRequestParams(QueryInstanceConsumeRequest requestObj) throws Exception {
        ...
        private JSONObject getPostRawRequestParams(QueryInstanceConsumeRequest requestObj) throws Exception {
            JSONObject requestParams = new JSONObject();
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, QueryInstanceConsumeRequest requestObj, Map<String, String> head,
