...
public class ListOperateLogsResponse extends BaseResponseModel {
    ...
    public static class EventsDto {
        ...
        private EventsRequestParametersDto RequestParameters;

        @Data
        @ToString
        public static class EventsRequestParametersDto {
        }
...
如果eventType取值不为ApiCall，该字段为简单的英文短句，表示事件含义。*/
        ...
        private EventsUserIdentityDto UserIdentity;

        @Data
        @ToString
        public static class EventsUserIdentityDto {
            /**如果是角色访问，则记录为角色名称*/
...
如果为IAM角色，则记录accouid：rolename*/
        ...
        private List<EventsReferencedResourcesDto> ReferencedResources;

        @Data
        @ToString
        public static class EventsReferencedResourcesDto {
        }
