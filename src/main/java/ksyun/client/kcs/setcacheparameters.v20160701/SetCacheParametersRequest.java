...
/**
 * @Classname SetCacheParametersRequest @Description 请求参数
 */
@Data
public class SetCacheParametersRequest {
  ...
  /**
   * 参数名称
   * N：表示数字，示例（Parameters.ParameterName.1=xx&Parameters.ParameterName.2=yy）参考请见：[参数组参数](https://docs.ksyun.com/documents/38470)(默认不修改)
   */
