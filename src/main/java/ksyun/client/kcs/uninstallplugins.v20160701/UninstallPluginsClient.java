...
public class UninstallPluginsClient extends BaseClient {
    ...
    public UninstallPluginsResponse doDelete(String path, UninstallPluginsRequest requestObj, Map<String, String> head) throws Exception {
        ...
        UninstallPluginsResponse UninstallPluginsResponse = JSON.parseObject(response, UninstallPluginsResponse.class);
        return UninstallPluginsResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(UninstallPluginsRequest requestObj) throws Exception {
