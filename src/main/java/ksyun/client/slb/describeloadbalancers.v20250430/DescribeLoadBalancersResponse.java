...
public class DescribeLoadBalancersResponse extends BaseResponseModel {
    ...
    private List<LoadBalancerSetDto> LoadBalancerSet;

    @Data
    @ToString
    public static class LoadBalancerSetDto {
        /**负载均衡的ID*/
        ...
        private LoadBalancerSetDtoWafInfoDto WafInfo;

        @Data
        @ToString
        public static class LoadBalancerSetDtoWafInfoDto {
            /**Waf产品的ID*/
            @JsonProperty("WafId")
        ...
        @JsonProperty("TagSet")
        private List<LoadBalancerSetDtoTagSetDto> TagSet;

        @Data
        @ToString
        public static class LoadBalancerSetDtoTagSetDto {
            /**资源ID*/
