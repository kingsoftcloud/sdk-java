...
public class DescribeLoadBalancersResponse extends BaseResponseModel {
    ...
    public static class LoadBalancerSetDto {
        ...
        private LoadBalancerSetWafInfoDto WafInfo;

        @Data
        @ToString
        public static class LoadBalancerSetWafInfoDto {
            /**Waf产品的ID*/
            @JsonProperty("WafId")
        ...
        @JsonProperty("TagSet")
        private List<LoadBalancerSetTagSetDto> TagSet;

        @Data
        @ToString
        public static class LoadBalancerSetTagSetDto {
            /**资源ID*/
