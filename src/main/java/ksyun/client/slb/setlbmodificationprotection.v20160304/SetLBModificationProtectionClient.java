...
public class SetLBModificationProtectionClient extends BaseClient {
    ...
    public SetLBModificationProtectionResponse doDelete(String path, SetLBModificationProtectionRequest requestObj, Map<String, String> head) throws Exception {
        ...
        SetLBModificationProtectionResponse SetLBModificationProtectionResponse = JSON.parseObject(response, SetLBModificationProtectionResponse.class);
        return SetLBModificationProtectionResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(SetLBModificationProtectionRequest requestObj) throws Exception {
