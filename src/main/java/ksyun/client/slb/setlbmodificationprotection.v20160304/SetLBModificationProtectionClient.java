...
public class SetLBModificationProtectionClient extends BaseClient {
     ...
     * @return SetLBModificationProtectionResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doPostSend(String path, SetLBModificationProtectionRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doPostSend(String path, SetLBModificationProtectionRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doPostSend(String path, SetLBModificationProtectionRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doPostSend(String path, SetLBModificationProtectionRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doGetSend(String path, SetLBModificationProtectionRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doGetSend(String path, SetLBModificationProtectionRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doGetSend(String path, SetLBModificationProtectionRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doPutSend(String path, SetLBModificationProtectionRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doPutSend(String path, SetLBModificationProtectionRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doPutSend(String path, SetLBModificationProtectionRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doDeleteSend(String path, SetLBModificationProtectionRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doDeleteSend(String path, SetLBModificationProtectionRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SetLBModificationProtectionResponse doDeleteSend(String path, SetLBModificationProtectionRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private SetLBModificationProtectionResponse executeWithV2(String method, String path, SetLBModificationProtectionRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, SetLBModificationProtectionResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, SetLBModificationProtectionRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, SetLBModificationProtectionRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, SetLBModificationProtectionRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, SetLBModificationProtectionRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, SetLBModificationProtectionRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, SetLBModificationProtectionRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, SetLBModificationProtectionRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, SetLBModificationProtectionRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    ...
    */
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, SetLBModificationProtectionRequest requestObj, Map<String, String> head,
