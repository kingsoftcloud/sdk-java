...
public class CreateSlbRuleResponse extends BaseResponseModel {
    ...
    public static class RuleDto {
        ...
        private RuleHealthCheckDto HealthCheck;

        @Data
        @ToString
        public static class RuleHealthCheckDto {
            /**HTTP类型健康检查的域名*/
        ...
        @Data
        @ToString
        public static class RuleSessionDto {
            /**会话保持的状态*/
        ...
        private List<RuleBackendServerSetDto> BackendServerSet;

        @Data
        @ToString
        public static class RuleBackendServerSetDto {
            /**后端服务的IP*/
