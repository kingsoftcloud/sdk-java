...
public class SetLoadBalancerStatusResponse extends BaseResponseModel {
    ...
    public static class LoadBalancerDto {
        ...
        private LoadBalancerWafInfoDto WafInfo;

        @Data
        @ToString
        public static class LoadBalancerWafInfoDto {
            /**Waf产品的ID*/
            @JsonProperty("WafId")
        ...
        @JsonProperty("TagSet")
        private List<LoadBalancerTagSetDto> TagSet;

        @Data
        @ToString
        public static class LoadBalancerTagSetDto {
            /**资源ID*/
