...
/**
* @Classname SetLoadBalancerStatusResponse
* @Description SetLoadBalancerStatus 返回体
*/
@Data
@ToString
public class SetLoadBalancerStatusResponse extends BaseResponseModel {
    /**请求ID*/
    ...
    public static class LoadBalancerDto {
        ...
        private LoadBalancerDtoWafInfoDto WafInfo;

        @Data
        @ToString
        public static class LoadBalancerDtoWafInfoDto {
            /**Waf产品的ID*/
            @JsonProperty("WafId")
        ...
        @JsonProperty("TagSet")
        private List<LoadBalancerDtoTagSetDto> TagSet;

        @Data
        @ToString
        public static class LoadBalancerDtoTagSetDto {
            /**资源ID*/
