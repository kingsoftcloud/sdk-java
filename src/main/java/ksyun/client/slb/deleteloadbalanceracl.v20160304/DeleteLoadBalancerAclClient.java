...
public class DeleteLoadBalancerAclClient extends BaseClient {
    ...
    */
    ...
    public DeleteLoadBalancerAclResponse doDelete(String path, DeleteLoadBalancerAclRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DeleteLoadBalancerAclResponse DeleteLoadBalancerAclResponse = JSON.parseObject(response, DeleteLoadBalancerAclResponse.class);
        return DeleteLoadBalancerAclResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(DeleteLoadBalancerAclRequest requestObj) throws Exception {
