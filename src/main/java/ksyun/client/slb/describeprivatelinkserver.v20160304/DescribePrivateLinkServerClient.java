...
public class DescribePrivateLinkServerClient extends BaseClient {
    ...
    */
    ...
    public DescribePrivateLinkServerResponse doDelete(String path, DescribePrivateLinkServerRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DescribePrivateLinkServerResponse DescribePrivateLinkServerResponse = JSON.parseObject(response, DescribePrivateLinkServerResponse.class);
        return DescribePrivateLinkServerResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(DescribePrivateLinkServerRequest requestObj) throws Exception {
