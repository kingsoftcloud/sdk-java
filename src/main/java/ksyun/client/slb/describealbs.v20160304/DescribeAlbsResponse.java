...
public class DescribeAlbsResponse extends BaseResponseModel {
    ...
    /**独享型负载均衡的信息*/
    @JsonProperty("ApplicationLoadBalancerSet")
    private List<ApplicationLoadBalancerSetDto> ApplicationLoadBalancerSet;

    @Data
    @ToString
    public static class ApplicationLoadBalancerSetDto {
        /**独享型负载均衡的ID*/
        @JsonProperty("AlbId")
        ...
        private ApplicationLoadBalancerSetWafInfoDto WafInfo;

        @Data
        @ToString
        public static class ApplicationLoadBalancerSetWafInfoDto {
            /**Waf产品的ID*/
            @JsonProperty("WafId")
        ...
        private List<ApplicationLoadBalancerSetResourceTagsDto> ResourceTags;

        @Data
        @ToString
        public static class ApplicationLoadBalancerSetResourceTagsDto {
            /**标签键*/
            @JsonProperty("Name")
            private String Name;
        ...
        @JsonProperty("TagSet")
        private List<ApplicationLoadBalancerSetTagSetDto> TagSet;

        @Data
        @ToString
        public static class ApplicationLoadBalancerSetTagSetDto {
            /**资源ID*/
