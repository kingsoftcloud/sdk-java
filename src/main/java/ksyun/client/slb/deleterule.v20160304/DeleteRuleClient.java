...
/**
 * @Classname DeleteRuleClient @Description 删除经典型负载均衡规则
 */
@Slf4j
public class DeleteRuleClient extends BaseClient {
  ...
  private static final String action = "DeleteRule";
   ...
   * @throws Exception
   */
  public DeleteRuleResponse doPost(
      String path, DeleteRuleRequest requestObj, Map<String, String> head) throws Exception {
   ...
   * @throws Exception
   */
  public DeleteRuleResponse doPostRaw(
      String path, DeleteRuleRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    String response = doRpc(path, requestObj, requestHeaders, "post");
   ...
   * @throws Exception
   */
  public DeleteRuleResponse doGet(
      String path, DeleteRuleRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public DeleteRuleResponse doDelete(
      String path, DeleteRuleRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
   ...
   * @throws Exception
   */
  public DeleteRuleResponse doPut(
      String path, DeleteRuleRequest requestObj, Map<String, String> head) throws Exception {
    final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
    requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
  ...
  private String doRpc(
      String path, DeleteRuleRequest requestObj, Map<String, String> head, String requestMethod)
      throws Exception {
    // 断言
  ...
  private JSONObject getRequestParam(DeleteRuleRequest requestObj, String contentType)
      throws Exception {
    // 请求参数
