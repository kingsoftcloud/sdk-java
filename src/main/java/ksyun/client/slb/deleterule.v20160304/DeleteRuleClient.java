...
public class DeleteRuleClient extends BaseClient {
    ...
    public DeleteRuleResponse doDelete(String path, DeleteRuleRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DeleteRuleResponse DeleteRuleResponse = JSON.parseObject(response, DeleteRuleResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(DeleteRuleRequest requestObj) throws Exception {
