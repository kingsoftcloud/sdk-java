...
/**
* @Classname DescribeAlbListenersResponse
* @Description DescribeAlbListeners 返回体
*/
@Data
@ToString
public class DescribeAlbListenersResponse extends BaseResponseModel {
    ...
    /**应用型监听器的信息*/
    @JsonProperty("AlbListenerSet")
    private List<AlbListenerSetDto> AlbListenerSet;

    @Data
    @ToString
    public static class AlbListenerSetDto {
        /**应用型负载均衡监听器的ID*/
