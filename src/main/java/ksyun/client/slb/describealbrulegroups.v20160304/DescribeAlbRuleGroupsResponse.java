...
public class DescribeAlbRuleGroupsResponse extends BaseResponseModel {
    ...
    /**转发策略的信息*/
    @JsonProperty("AlbRuleGroupSet")
    private List<AlbRuleGroupSetDto> AlbRuleGroupSet;

    @Data
    @ToString
    public static class AlbRuleGroupSetDto {
        /**转发策略的ID*/
        ...
        private List<AlbRuleGroupSetAlbRuleSetDto> AlbRuleSet;

        @Data
        @ToString
        public static class AlbRuleGroupSetAlbRuleSetDto {
            ...
            private List<AlbRuleGroupSetAlbRuleSetHeaderValueDto> HeaderValue;

            @Data
            @ToString
            public static class AlbRuleGroupSetAlbRuleSetHeaderValueDto {
                /**HTTP标头,查询字符串的键值*/
                @JsonProperty("Key")
                private String Key;
            ...
            private List<AlbRuleGroupSetAlbRuleSetQueryValueDto> QueryValue;

            @Data
            @ToString
            public static class AlbRuleGroupSetAlbRuleSetQueryValueDto {
                /**HTTP标头,查询字符串的键值*/
                @JsonProperty("Key")
                private String Key;
            ...
            private List<AlbRuleGroupSetAlbRuleSetCookieValueDto> CookieValue;

            @Data
            @ToString
            public static class AlbRuleGroupSetAlbRuleSetCookieValueDto {
                /**HTTP标头,查询字符串的键值*/
                @JsonProperty("Key")
                private String Key;
        ...
        private AlbRuleGroupSetRewriteConfigDto RewriteConfig;

        @Data
        @ToString
        public static class AlbRuleGroupSetRewriteConfigDto {
            /**重写的域名*/
        ...
        private AlbRuleGroupSetFixedResponseConfigDto FixedResponseConfig;

        @Data
        @ToString
        public static class AlbRuleGroupSetFixedResponseConfigDto {
