...
public class DescribeRulesResponse extends BaseResponseModel {
    ...
    public static class RuleSetDto {
        ...
        private RuleSetHealthCheckDto HealthCheck;

        @Data
        @ToString
        public static class RuleSetHealthCheckDto {
            /**HTTP类型健康检查的域名*/
        ...
        private RuleSetSessionDto Session;

        @Data
        @ToString
        public static class RuleSetSessionDto {
            /**会话保持的状态*/
        ...
        private List<RuleSetBackendServerSetDto> BackendServerSet;

        @Data
        @ToString
        public static class RuleSetBackendServerSetDto {
            /**后端服务的IP*/
