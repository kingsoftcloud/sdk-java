...
public class DescribeRulesClient extends BaseClient {
    ...
    private final static String action = "DescribeRules";
    ...
    public DescribeRulesClient(Credential credential) {
     ...
     * @return DescribeRulesResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doPostSend(String path, DescribeRulesRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doPostSend(String path, DescribeRulesRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doPostSend(String path, DescribeRulesRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doPostSend(String path, DescribeRulesRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doGetSend(String path, DescribeRulesRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doGetSend(String path, DescribeRulesRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doGetSend(String path, DescribeRulesRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doPutSend(String path, DescribeRulesRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doPutSend(String path, DescribeRulesRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doPutSend(String path, DescribeRulesRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doDeleteSend(String path, DescribeRulesRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doDeleteSend(String path, DescribeRulesRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeRulesResponse doDeleteSend(String path, DescribeRulesRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private DescribeRulesResponse executeWithV2(String method, String path, DescribeRulesRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, DescribeRulesResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, DescribeRulesRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, DescribeRulesRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, DescribeRulesRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, DescribeRulesRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, DescribeRulesRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, DescribeRulesRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, DescribeRulesRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, DescribeRulesRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws Exception
     */
    public DescribeRulesResponse doPost(String path, DescribeRulesRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
    ...
    */
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, DescribeRulesRequest requestObj, Map<String, String> head,
