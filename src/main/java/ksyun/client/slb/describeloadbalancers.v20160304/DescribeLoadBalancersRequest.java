...
/**
 * @Classname DescribeLoadBalancersRequest @Description 请求参数
 */
@Data
public class DescribeLoadBalancersRequest {
  ...
  public static class FilterDto {
    /**
     * 有效值： - vpc-id，Vpc的ID - load-balancer-name，负载均衡名称 - load-balancer-type，负载均衡类型 - public-ip，IP地址
     * - load-balancer-ipversion，IP版本 - not-vpc-id，不属于的Vpc的ID
     */
