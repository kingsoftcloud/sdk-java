...
public class DescribeListenersResponse extends BaseResponseModel {
    ...
    public static class ListenerSetDto {
        ...
        private List<ListenerSetBackendServerGroupIdSetDto> BackendServerGroupIdSet;

        @Data
        @ToString
        public static class ListenerSetBackendServerGroupIdSetDto {
            /**后端服务器组的ID*/
        ...
        private List<ListenerSetRealServerDto> RealServer;

        @Data
        @ToString
        public static class ListenerSetRealServerDto {
            /**绑定服务器组的注册ID*/
...
- host类型，填写云主机或者云物理主机的ID*/
        ...
        private List<ListenerSetBackendServerSetDto> BackendServerSet;

        @Data
        @ToString
        public static class ListenerSetBackendServerSetDto {
            /**所属后端服务组的ID*/
            @JsonProperty("BackendServerGroupId")
            private String BackendServerGroupId;
