...
/**
* @Classname ModifyLoadBalancerAclResponse
* @Description ModifyLoadBalancerAcl 返回体
*/
@Data
@ToString
public class ModifyLoadBalancerAclResponse extends BaseResponseModel {
    ...
    public static class LoadBalancerAclDto {
        ...
        private List<LoadBalancerAclLoadBalancerAclEntrySetDto> LoadBalancerAclEntrySet;

        @Data
        @ToString
        public static class LoadBalancerAclLoadBalancerAclEntrySetDto {
            /**ACL的ID*/
            @JsonProperty("LoadBalancerAclId")
            private String LoadBalancerAclId;
