...
public class DescribeMongoDBShardNodeClient extends BaseClient {
     ...
     * @return DescribeMongoDBShardNodeResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doPostSend(String path, DescribeMongoDBShardNodeRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doPostSend(String path, DescribeMongoDBShardNodeRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doPostSend(String path, DescribeMongoDBShardNodeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doPostSend(String path, DescribeMongoDBShardNodeRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doGetSend(String path, DescribeMongoDBShardNodeRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doGetSend(String path, DescribeMongoDBShardNodeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doGetSend(String path, DescribeMongoDBShardNodeRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doPutSend(String path, DescribeMongoDBShardNodeRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doPutSend(String path, DescribeMongoDBShardNodeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doPutSend(String path, DescribeMongoDBShardNodeRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doDeleteSend(String path, DescribeMongoDBShardNodeRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doDeleteSend(String path, DescribeMongoDBShardNodeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public DescribeMongoDBShardNodeResponse doDeleteSend(String path, DescribeMongoDBShardNodeRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private DescribeMongoDBShardNodeResponse executeWithV2(String method, String path, DescribeMongoDBShardNodeRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, DescribeMongoDBShardNodeResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, DescribeMongoDBShardNodeRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, DescribeMongoDBShardNodeRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, DescribeMongoDBShardNodeRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, DescribeMongoDBShardNodeRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, DescribeMongoDBShardNodeRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, DescribeMongoDBShardNodeRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, DescribeMongoDBShardNodeRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, DescribeMongoDBShardNodeRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
    ...
    * @throws Exception
    */
    public DescribeMongoDBShardNodeResponse doPostRaw(String path, DescribeMongoDBShardNodeRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
    ...
    * @throws Exception
    */
    public DescribeMongoDBShardNodeResponse doPostRaw(String path, DescribeMongoDBShardNodeRequest requestObj, Map<String, String> head) throws Exception {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
        String response = doRpc(path, requestObj, requestHeaders, "post");
        return JSON.parseObject(response, DescribeMongoDBShardNodeResponse.class);
    ...
    /**
         ...
         * @throws Exception
         */
        private String doRpc(String path, DescribeMongoDBShardNodeRequest requestObj, Map<String, String> head, String requestMethod) throws Exception {
            //断言
        ...
        private JSONObject getRequestParam(DescribeMongoDBShardNodeRequest requestObj, String contentType) throws Exception {
            //请求参数
        ...
        private JSONObject getSimpleRequestParams(DescribeMongoDBShardNodeRequest requestObj) throws Exception {
        ...
        private JSONObject getPostRawRequestParams(DescribeMongoDBShardNodeRequest requestObj) throws Exception {
            JSONObject requestParams = new JSONObject();
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, DescribeMongoDBShardNodeRequest requestObj, Map<String, String> head,
