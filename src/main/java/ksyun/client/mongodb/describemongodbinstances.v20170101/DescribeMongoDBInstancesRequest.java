...
/**
 * @Classname DescribeMongoDBInstancesRequest @Description 请求参数
 */
@Data
public class DescribeMongoDBInstancesRequest {
   ...
   *
   * <p>可选（
   * 共11种）：running，deleting，restarting，locking，unlocking，locked，backuping，restoring，restoring_backup，switching_role，migrating。
   */
