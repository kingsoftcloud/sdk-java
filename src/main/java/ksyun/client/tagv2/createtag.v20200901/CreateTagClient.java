...
public class CreateTagClient extends BaseClient {
    ...
    */
    ...
    public CreateTagResponse doDelete(String path, CreateTagRequest requestObj, Map<String, String> head) throws Exception {
        ...
        CreateTagResponse CreateTagResponse = JSON.parseObject(response, CreateTagResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(CreateTagRequest requestObj) throws Exception {
