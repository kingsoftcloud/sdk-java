...
public class GetDomainRankingListDataClient extends BaseClient {
    ...
    public GetDomainRankingListDataResponse doDelete(String path, GetDomainRankingListDataRequest requestObj, Map<String, String> head) throws Exception {
        ...
        GetDomainRankingListDataResponse GetDomainRankingListDataResponse = JSON.parseObject(response, GetDomainRankingListDataResponse.class);
        return GetDomainRankingListDataResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(GetDomainRankingListDataRequest requestObj) throws Exception {
