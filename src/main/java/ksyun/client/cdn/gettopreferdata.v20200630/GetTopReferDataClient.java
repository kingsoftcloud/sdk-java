...
public class GetTopReferDataClient extends BaseClient {
    ...
    public GetTopReferDataResponse doDelete(String path, GetTopReferDataRequest requestObj, Map<String, String> head) throws Exception {
        ...
        GetTopReferDataResponse GetTopReferDataResponse = JSON.parseObject(response, GetTopReferDataResponse.class);
        return GetTopReferDataResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(GetTopReferDataRequest requestObj) throws Exception {
