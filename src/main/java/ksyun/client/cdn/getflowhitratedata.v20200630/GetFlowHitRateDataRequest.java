...
/**
 * @Classname GetFlowHitRateDataRequest @Description 请求参数
 */
@Data
public class GetFlowHitRateDataRequest {
   ...
   * 5：5分钟粒度；60：1小时粒度；1440：1天粒度；5分钟及以上粒度的值取该粒度时间段内的5分钟粒度的流量值累加和，缺省为5分钟粒度。1分钟粒度查询范围最大跨度为24小时，5分钟粒度查询范围最大跨度为31天，其余粒度查询范围最大跨度为90天
   */
