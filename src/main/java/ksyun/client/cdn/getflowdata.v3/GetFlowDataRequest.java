...
/**
* @Classname GetFlowDataRequest
* @Description 请求参数
*/
@Data
public class GetFlowDataRequest{
    ...
    /**区域名称，枚举类型表见[使用须知](使用须知)，支持多区域查询，多个区域用逗号（半角）分隔，缺省为 CN缺省为 CN*/
    ...
    /**协议类型， 取值为http：htts协议数据； https：https协议数据；缺省默认返回全部协议数据*/
