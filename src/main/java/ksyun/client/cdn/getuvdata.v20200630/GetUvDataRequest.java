...
/**
 * @Classname GetUvDataRequest @Description 请求参数
 */
@Data
public class GetUvDataRequest {
  ...
  /**
   * 统计粒度，取值为 5（默认）：5分钟粒度；1440：1天粒度。<br>
   * 注：当选择粒度是 1440：1天粒度 时， ResultType 必须是 expand ， StartTime 和 EndTime 都必须是 T00:00+0800
   * 结尾，比如：StartTime 是2022-08-01T00:00+0800、EndTime 是2022-08-06T00:00+0800，表示查询2022-08-01 到
   * 2022-08-05 的天粒度数据；可以是多天查询，最大支持31天的跨度查询。天粒度上线较晚，是在2022-07-05迭代上线，故最早可查询 2022-07-05的天粒度数据。
   */
