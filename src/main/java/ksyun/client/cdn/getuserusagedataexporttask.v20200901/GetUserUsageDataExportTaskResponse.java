...
public class GetUserUsageDataExportTaskResponse extends BaseResponseModel {
    ...
    public static class UsageDataPerPageDto {
        ...
        private List<UsageDataPerPageDataItemDto> DataItem;

        @Data
        @ToString
        public static class UsageDataPerPageDataItemDto {
            /***/
            @JsonProperty("TaskId")
            ...
            private UsageDataPerPageDataItemTaskConfigDto TaskConfig;

            @Data
            @ToString
            public static class UsageDataPerPageDataItemTaskConfigDto {
                /***/
