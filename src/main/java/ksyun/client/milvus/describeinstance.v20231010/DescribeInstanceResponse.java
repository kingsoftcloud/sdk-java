...
UNKNOWN  未知	*/
        ...
        private List<DataAddressesDto> Addresses;

        @Data
        @ToString
        public static class DataAddressesDto {
            /**节点IP*/
            @JsonProperty("Host")
            private String Host;
...
eip*/
        ...
        private DataResourcesDto Resources;

        @Data
        @ToString
        public static class DataResourcesDto {
            /***/
            @JsonProperty("CU")
            private DataResourcesCUDto CU;

            @Data
            @ToString
            public static class DataResourcesCUDto {
                /**个数(单位为cu)*/
                @JsonProperty("CU")
                private Integer CU;
...
capacity 容量型*/
        ...
        /**实例用户信息列表*/
        @JsonProperty("Users")
        private List<DataUsersDto> Users;

        @Data
        @ToString
        public static class DataUsersDto {
            /**用户ID*/
            @JsonProperty("Id")
            private String Id;
