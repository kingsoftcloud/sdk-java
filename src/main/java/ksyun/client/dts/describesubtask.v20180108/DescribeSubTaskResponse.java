...
```*/
    ...
    public static class DataDto {
        ...
        /***/
        @JsonProperty("Object")
        private List<DataObjectDto> Object;

        @Data
        @ToString
        public static class DataObjectDto {
            /***/
            ...
            /***/
            @JsonProperty("ObjectSourceSchema")
            private String ObjectSourceSchema;

            /***/
            @JsonProperty("ObjectTargetSchema")
            private String ObjectTargetSchema;

            /***/
            @JsonProperty("ObjectTotalCount")
            private Integer ObjectTotalCount;

            /***/
            @JsonProperty("ObjectTargetCount")
            private Integer ObjectTargetCount;
