...
public class DescribeConnConfigResponse extends BaseResponseModel {
    ...
    public static class DataDto {
        ...
        private DataConnConfigDto ConnConfig;

        @Data
        @ToString
        public static class DataConnConfigDto {
            /**迁移配置ID*/
            @JsonProperty("Id")
            private String Id;
...
注意：若是迁移类型不支持结构化迁移的话，是没法指定具体的库表信息的*/
            ...
            private DataConnConfigDbSchemaDto DbSchema;

            @Data
            @ToString
            public static class DataConnConfigDbSchemaDto {
                /***/
