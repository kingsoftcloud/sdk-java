...
21-全部实例开通失败，全部退款;*/
    ...
    public static class OrderListDto {
        ...
        private List<OrderListProductItemsDto> ProductItems;

        @Data
        @ToString
        public static class OrderListProductItemsDto {
            /***/
            @JsonProperty("key")
            private String Key;
        ...
        private OrderListPromotionItemDto PromotionItem;

        @Data
        @ToString
        public static class OrderListPromotionItemDto {
            /**活动名称*/
            @JsonProperty("name")
            private String Name;
