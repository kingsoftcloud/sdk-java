...
21-全部实例开通失败，全部退款;*/
        ...
        private List<DataOrderListDto> OrderList;

        @Data
        @ToString
        public static class DataOrderListDto {
            /**计费方式ID*/
            ...
            private List<DataOrderListProductItemsDto> ProductItems;

            @Data
            @ToString
            public static class DataOrderListProductItemsDto {
                /***/
                @JsonProperty("key")
                private String Key;
            ...
            private DataOrderListPromotionItemDto PromotionItem;

            @Data
            @ToString
            public static class DataOrderListPromotionItemDto {
                /**活动名称*/
                @JsonProperty("name")
                private String Name;
