...
public class ListDownloadTasksClient extends BaseClient {
    ...
    public ListDownloadTasksResponse doDelete(String path, ListDownloadTasksRequest requestObj, Map<String, String> head) throws Exception {
        ...
        ListDownloadTasksResponse ListDownloadTasksResponse = JSON.parseObject(response, ListDownloadTasksResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(ListDownloadTasksRequest requestObj) throws Exception {
