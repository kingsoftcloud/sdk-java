...
public class CreateDownloadTaskClient extends BaseClient {
    ...
    */
    ...
    public CreateDownloadTaskResponse doDelete(String path, CreateDownloadTaskRequest requestObj, Map<String, String> head) throws Exception {
        ...
        CreateDownloadTaskResponse CreateDownloadTaskResponse = JSON.parseObject(response, CreateDownloadTaskResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(CreateDownloadTaskRequest requestObj) throws Exception {
