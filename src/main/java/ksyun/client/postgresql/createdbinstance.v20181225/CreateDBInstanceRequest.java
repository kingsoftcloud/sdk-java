...
public class CreateDBInstanceRequest {
   ...
   *
   * <p>| 实例规格 | 最大连接数 | 读IOPS | 写IOPS | 对应磁盘取值范围(步长均为5) | | :- | - | - | - | - | | **1G** | 200 |
   * 1200 | 1200 | *5~40* | | **2G** | 400 | 2400 | 2400 | *5~80* | | **4G** | 800 | 4800 | 4800 |
   * *5~200* | | **8G** | 1600 | 9600 | 9600 | *5~300* | | **12G** | 2400 | 14400 | 14400 | *5~500*
   * | | **16G** | 3200 | 19200 | 19200 | *5~600* | | **24G** | 4800 | 28800 | 28800 | *5~1000* | |
   * **32G** | 6400 | 38400 | 38400 | *5~1500* | | **48G** | 9600 | 57600 |  57600 | *5~2000* |
   */
  @KsYunField(name = "Mem")
  private Integer Mem;
  ...
  /** 实例数据库引擎名称 取固定值：postgresql */
  @KsYunField(name = "Engine")
  private String Engine;

  /** 实例数据库引擎版本 取值范围：9.6 |  10  |   11  |   12.5  |   13 */
  ...
  /** 数据库用户名 root, rdsrepladmin, rdsadmin,dtsroot, postgres不可用 */
  ...
  /** 购买时长 默认值：1 单位为月,选择YEAR_MONTH时计费方式必传. */
  @KsYunField(name = "Duration")
  private String Duration;

  /** 购买时长单位 取值范围：M（月），默认值：M（区分大小写）,选择YEAR_MONTH时计费方式必传. */
