...
/**
 * @Classname DescribeDBLogFilesRequest @Description 请求参数
 */
@Data
public class DescribeDBLogFilesRequest {
   ...
   * 日志类型
   *
   * <p>##### 取值范围：Log/SlowLog/ErrorLog/Binlog
   */
  @KsYunField(name = "DBLogType")
  private String DBLogType;

  /** 日志开始记录时间 ##### 按照yyyy-MM-dd HH:mm:ss格式 */
  @KsYunField(name = "StartTime")
  private String StartTime;

  /** 日志结束记录时间 ##### 按照yyyy-MM-dd HH:mm:ss格式 */
  @KsYunField(name = "EndTime")
  private String EndTime;

  /** 最大文件大小 ##### 过滤文件大小大于MaxFileSize的文件，单位：字节 */
