...
public class ModifySecurityGroupRuleRequest {
   ...
   * 安全组规则操作
   *
   * <p>```json 1.取值范围:Attach|Delete|Cover 2.Attach:
  ...
  public static class SecurityGroupRuleDto {
     ...
     * 安全组规则ID
     *
     * <p>```json 若安全组规则列表操作项选择Delete,择必传 ```
     */
     ...
     * 规则名称列表
     *
     * <p>```json 若安全组规则列表操作项选择Attach或Cover,择必传.  不超过256个字节，仅支持中文、大小写字母、数字、减号和下划线 ```
     */
     ...
     * 规则ip列表
     *
     * <p>```json 若安全组规则列表操作项选择Attach或Cover,择必传 ```
     */
