...
public class DescribeDBBackupsClient extends BaseClient {
    ...
    public DescribeDBBackupsResponse doDelete(String path, DescribeDBBackupsRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DescribeDBBackupsResponse DescribeDBBackupsResponse = JSON.parseObject(response, DescribeDBBackupsResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(DescribeDBBackupsRequest requestObj) throws Exception {
