...
public class ModifySecurityGroupClient extends BaseClient {
    ...
    public ModifySecurityGroupResponse doDelete(String path, ModifySecurityGroupRequest requestObj, Map<String, String> head) throws Exception {
        ...
        ModifySecurityGroupResponse ModifySecurityGroupResponse = JSON.parseObject(response, ModifySecurityGroupResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(ModifySecurityGroupRequest requestObj) throws Exception {
