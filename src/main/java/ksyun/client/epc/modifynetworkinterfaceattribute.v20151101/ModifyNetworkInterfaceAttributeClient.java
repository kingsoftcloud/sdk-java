...
public class ModifyNetworkInterfaceAttributeClient extends BaseClient {
    ...
    private final static String action = "ModifyNetworkInterfaceAttribute";
     ...
     * @return ModifyNetworkInterfaceAttributeResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doPostSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doPostSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doPostSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doPostSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doGetSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doGetSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doGetSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doPutSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doPutSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doPutSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doDeleteSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doDeleteSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public ModifyNetworkInterfaceAttributeResponse doDeleteSend(String path, ModifyNetworkInterfaceAttributeRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private ModifyNetworkInterfaceAttributeResponse executeWithV2(String method, String path, ModifyNetworkInterfaceAttributeRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, ModifyNetworkInterfaceAttributeResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, ModifyNetworkInterfaceAttributeRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, ModifyNetworkInterfaceAttributeRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, ModifyNetworkInterfaceAttributeRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, ModifyNetworkInterfaceAttributeRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws Exception
     */
    public ModifyNetworkInterfaceAttributeResponse doPost(String path, ModifyNetworkInterfaceAttributeRequest requestObj) throws Exception {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/x-www-form-urlencoded");
     ...
     * @throws Exception
     */
    public ModifyNetworkInterfaceAttributeResponse doPost(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head) throws Exception {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    ...
    * @throws Exception
    */
    public ModifyNetworkInterfaceAttributeResponse doPostRaw(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head) throws Exception {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
        String response = doRpc(path, requestObj, requestHeaders, "post");
        return JSON.parseObject(response, ModifyNetworkInterfaceAttributeResponse.class);
    ...
    public ModifyNetworkInterfaceAttributeResponse doGet(String path, ModifyNetworkInterfaceAttributeRequest requestObj) throws Exception {
         ...
         * @throws Exception
         */
        public ModifyNetworkInterfaceAttributeResponse doGet(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head) throws Exception {
            final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
            requestHeaders.putIfAbsent("Content-Type", "application/x-www-form-urlencoded");
    ...
    /**
         ...
         * @throws Exception
         */
        private String doRpc(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head, String requestMethod) throws Exception {
            //断言
        ...
        private JSONObject getRequestParam(ModifyNetworkInterfaceAttributeRequest requestObj, String contentType) throws Exception {
            //请求参数
        ...
        private JSONObject getPostRawRequestParams(ModifyNetworkInterfaceAttributeRequest requestObj) throws Exception {
            JSONObject requestParams = new JSONObject();
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, ModifyNetworkInterfaceAttributeRequest requestObj, Map<String, String> head,
