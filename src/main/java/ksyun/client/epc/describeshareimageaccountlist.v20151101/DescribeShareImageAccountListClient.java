...
public class DescribeShareImageAccountListClient extends BaseClient {
    ...
    public DescribeShareImageAccountListResponse doDelete(String path, DescribeShareImageAccountListRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DescribeShareImageAccountListResponse DescribeShareImageAccountListResponse = JSON.parseObject(response, DescribeShareImageAccountListResponse.class);
        return DescribeShareImageAccountListResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(DescribeShareImageAccountListRequest requestObj) throws Exception {
