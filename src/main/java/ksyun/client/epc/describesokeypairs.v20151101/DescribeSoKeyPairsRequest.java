...
/**
 * @Classname DescribeSoKeyPairsRequest @Description 请求参数
 */
@Data
public class DescribeSoKeyPairsRequest {
  ...
  /**
   * 密钥对ID，最多支持100个。 • 参数 - N：表示密钥对ID的序号。 • 多个密钥对ID之间用&分隔。
   * 示例值：KeyPairIds.1=2c67be69-b508-48e4-a460-fe491e8d49ba
   */
  @KsYunField(name = "KeyPairIds")
  ...
  /** 密钥对名称，最多支持100个。 • 参数 - N：表示密钥对的序号。 • 多个密钥对之间用&分隔。 */
  @KsYunField(name = "KeyPairNames")
  private List<String> KeyPairNamesList;

  /** 分页查询时设置的每页行数。 • 最大值：500 • 默认值：10 */
