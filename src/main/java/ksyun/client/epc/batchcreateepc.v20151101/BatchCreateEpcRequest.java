...
/**
 * @Classname BatchCreateEpcRequest @Description 请求参数
 */
@Data
public class BatchCreateEpcRequest {
  ...
  /** 有效值： ▪ support：开启 ▪ unsupport：关闭 默认值：unsupport */
  @KsYunField(name = "PasswordInherit")
  private String PasswordInherit;

  /** 有效值： ▪ support：开启 ▪ unsupport：关闭 默认值：support */
