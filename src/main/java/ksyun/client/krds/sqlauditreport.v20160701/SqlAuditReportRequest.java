...
/**
 * @Classname SqlAuditReportRequest @Description 请求参数
 */
@Data
public class SqlAuditReportRequest {
  ...
  /**
   * 查询间隔 最近1小时：LASTEST_ONE_HOUR<br>
   * 最近3小时：LASTEST_THREE_HOUR<br>
   * 最近1天：LASTEST_ONE_DAY<br>
   * 最近1周：LASTEST_ONE_WEEK<br>
   * 自定义查询时间：CUSTOM<br>
   * 注意：自定义查询时间的时候必须填写startTime和endTime<br>
  ...
  /**
   * 排序字段 默认执行次数(count)倒序排序：<br>
   * 排序字段：<br>
   * count：执行次数<br>
   * countRatio：执行次数比例<br>
   * durationAvg: 平均执行耗时<br>
   * durationRatio: 执行耗时占比
   */
