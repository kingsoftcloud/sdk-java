...
public class SqlAuditReportClient extends BaseClient {
     ...
     * @return SqlAuditReportResponse 响应对象
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doPostSend(String path, SqlAuditReportRequest requestObj) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doPostSend(String path, SqlAuditReportRequest requestObj,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doPostSend(String path, SqlAuditReportRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doPostSend(String path, SqlAuditReportRequest requestObj, Map<String, String> head,
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doGetSend(String path, SqlAuditReportRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doGetSend(String path, SqlAuditReportRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doGetSend(String path, SqlAuditReportRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doPutSend(String path, SqlAuditReportRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doPutSend(String path, SqlAuditReportRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doPutSend(String path, SqlAuditReportRequest requestObj,
                                        UrlPathParams urlPathParams,
                                        Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doDeleteSend(String path, SqlAuditReportRequest requestObj) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doDeleteSend(String path, SqlAuditReportRequest requestObj, Map<String, String> head) throws RuntimeException {
     ...
     * @throws RuntimeException 如果请求失败
     */
    public SqlAuditReportResponse doDeleteSend(String path, SqlAuditReportRequest requestObj,
                                           UrlPathParams urlPathParams,
                                           Map<String, String> customHeaders) throws RuntimeException {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @throws RuntimeException 如果请求失败
     */
    private SqlAuditReportResponse executeWithV2(String method, String path, SqlAuditReportRequest requestObj,
        ...
        // 4. 解析 JSON 响应
        try {
            return JSON.parseObject(message, SqlAuditReportResponse.class);
        } catch (Exception e) {
            throw new RuntimeException(
     ...
     */
    public HttpResponseWrapper doPostWithContextV2(String path, SqlAuditReportRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPostWithContextV2(String path, SqlAuditReportRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, SqlAuditReportRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doGetWithContextV2(String path, SqlAuditReportRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, SqlAuditReportRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doPutWithContextV2(String path, SqlAuditReportRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, SqlAuditReportRequest requestObj) {
        Map<String, String> head = new HashMap<>();
        head.put("Content-Type", "application/json");
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    public HttpResponseWrapper doDeleteWithContextV2(String path, SqlAuditReportRequest requestObj, Map<String, String> head) {
        final Map<String, String> requestHeaders = head != null ? new HashMap<>(head) : new HashMap<>();
        requestHeaders.putIfAbsent("Content-Type", "application/json");
    ...
    */
     ...
     * @return HttpResponseWrapper 包含状态码和原始响应消息
     */
    private HttpResponseWrapper doRpcV2(String path, SqlAuditReportRequest requestObj, Map<String, String> head,
