...
public class SqlAuditReportClient extends BaseClient {
    ...
    public SqlAuditReportResponse doDelete(String path, SqlAuditReportRequest requestObj, Map<String, String> head) throws Exception {
        ...
        SqlAuditReportResponse SqlAuditReportResponse = JSON.parseObject(response, SqlAuditReportResponse.class);
        return SqlAuditReportResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(SqlAuditReportRequest requestObj) throws Exception {
