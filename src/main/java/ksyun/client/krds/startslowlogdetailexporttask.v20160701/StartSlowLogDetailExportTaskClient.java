 ...
 * @Description start slow log detail export task
 */
@Slf4j
public class StartSlowLogDetailExportTaskClient extends BaseClient {
    ...
    public StartSlowLogDetailExportTaskResponse doDelete(String path, StartSlowLogDetailExportTaskRequest requestObj, Map<String, String> head) throws Exception {
        ...
        StartSlowLogDetailExportTaskResponse StartSlowLogDetailExportTaskResponse = JSON.parseObject(response, StartSlowLogDetailExportTaskResponse.class);
        return StartSlowLogDetailExportTaskResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(StartSlowLogDetailExportTaskRequest requestObj) throws Exception {
