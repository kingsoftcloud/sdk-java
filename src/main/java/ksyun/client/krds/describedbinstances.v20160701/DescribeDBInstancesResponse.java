...
3 互信VPC实例*/
            ...
            private List<DataInstancesBindInstancesDto> BindInstances;

            @Data
            @ToString
            public static class DataInstancesBindInstancesDto {
                /**状态*/
                @JsonProperty("Status")
            ...
            private List<DataInstancesProxyNodeInfoDto> ProxyNodeInfo;

            @Data
            @ToString
            public static class DataInstancesProxyNodeInfoDto {
                /**名称*/
                @JsonProperty("Name")
                private String Name;
