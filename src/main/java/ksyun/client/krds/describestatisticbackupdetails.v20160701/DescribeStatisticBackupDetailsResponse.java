...
注意：备份信息、Binglog信息数据域只会返回其中一项*/
    ...
    public static class DataDto {
        ...
        private List<DataBackupsDto> Backups;

        @Data
        @ToString
        public static class DataBackupsDto {
            /**备份名称*/
            @JsonProperty("Name")
            private String Name;
...
ks3下载路径，注意文件较大容易超时！*/
        ...
        private List<DataBinlogTasksDto> BinlogTasks;

        @Data
        @ToString
        public static class DataBinlogTasksDto {
            /**名称*/
