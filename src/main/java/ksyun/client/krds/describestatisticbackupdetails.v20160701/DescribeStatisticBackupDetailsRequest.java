...
/**
 * @Classname DescribeStatisticBackupDetailsRequest @Description 请求参数
 */
@Data
public class DescribeStatisticBackupDetailsRequest {
  /** 必传：数据类型，区分查询类型； backup：实例备份； binglog：实例binglog备份； delbackup：已删除实例备份； */
  @KsYunField(name = "DataType")
  private String DataType;

  /** 快照：snapshot 自动备份：autobackup */
