...
public class DeleteTriggerClient extends BaseClient {
    ...
    public DeleteTriggerResponse doDelete(String path, DeleteTriggerRequest requestObj, Map<String, String> head) throws Exception {
        ...
        DeleteTriggerResponse DeleteTriggerResponse = JSON.parseObject(response, DeleteTriggerResponse.class);
     ...
     * @return
     */
    private JSONObject getRequestParams(DeleteTriggerRequest requestObj) throws Exception {
