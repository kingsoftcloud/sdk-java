...
public class OpenFunctionServiceClient extends BaseClient {
    ...
    public OpenFunctionServiceResponse doDelete(String path, OpenFunctionServiceRequest requestObj, Map<String, String> head) throws Exception {
        ...
        OpenFunctionServiceResponse OpenFunctionServiceResponse = JSON.parseObject(response, OpenFunctionServiceResponse.class);
        return OpenFunctionServiceResponse;
    }
     ...
     * @return
     */
    private JSONObject getRequestParams(OpenFunctionServiceRequest requestObj) throws Exception {
